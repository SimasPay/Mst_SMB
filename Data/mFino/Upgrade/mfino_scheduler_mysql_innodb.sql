...
DROP TABLE IF EXISTS MFINO_SIMPROP_TRIGGERS;
...
REFERENCES MFINO_JOB_DETAILS(SCHED_NAME,JOB_NAME,JOB_GROUP))
TYPE=InnoDB;
...
REFERENCES MFINO_TRIGGERS(SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP))
TYPE=InnoDB;
...
CREATE TABLE MFINO_SIMPROP_TRIGGERS
  (          
    SCHED_NAME VARCHAR(120) NOT NULL,
    TRIGGER_NAME VARCHAR(200) NOT NULL,
    TRIGGER_GROUP VARCHAR(200) NOT NULL,
