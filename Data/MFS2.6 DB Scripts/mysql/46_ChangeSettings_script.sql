...
(1,now(),'system',now(),'system',1,'ChangeSettings','ChangeSettings');
...
(1,now(),'system',now(),'system',1,(select id from service where ServiceName='Account'),(select id from transaction_type where TransactionName='ChangeSettings'));
