...
DROP PROCEDURE IF EXISTS prefix_nc_token_to_notification_text;
delimiter //
Create Procedure prefix_nc_token_to_notification_text()
Begin
	...
	LOOP1: loop
		...
		SELECT CONCAT('$(NotificationCode) ', notificationText) into notificationText;
...
CALL prefix_nc_token_to_notification_text();

DROP PROCEDURE prefix_nc_token_to_notification_text;