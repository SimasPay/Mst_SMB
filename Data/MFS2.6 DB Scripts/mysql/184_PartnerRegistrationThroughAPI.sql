INSERT INTO `system_parameters` (Version, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, ParameterName, ParameterValue, Description) VALUES (1,now(),'System',now(),'system','allowed.partners.toregister.throughapi','7,8','allowed.partners.toregister.throughapi');
INSERT INTO system_parameters (Version, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, ParameterName, ParameterValue, Description) VALUES (1,now(),'System',now(),'system','partner.register.throughapi.approvalrequired','true','partner.register.throughapi.approvalrequired');
...
(1,now(),'system',now(),'system',1,'PartnerRegistrationThroughAPI','PartnerRegistrationThroughAPI');
...
(1,now(),'system',now(),'system',1,(select id from service where ServiceName='Account'), (select id from transaction_type where TransactionName='PartnerRegistrationThroughAPI'));
