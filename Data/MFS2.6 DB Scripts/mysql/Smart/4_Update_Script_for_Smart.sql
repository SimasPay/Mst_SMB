...
INSERT INTO enum_text (VERSION, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, LANGUAGE, TagName, TagID, EnumCode, EnumValue, DisplayText) VALUES ('1',now(),'system',now(),'system','0','Language','5134','1','Bahasa','Bahasa');

Delete from enum_text where tagid = 5135 and  enumcode = 'IDR';
INSERT INTO enum_text (VERSION, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, LANGUAGE, TagName, TagID, EnumCode, EnumValue, DisplayText) VALUES ('1',now(),'system',now(),'system','0','Currency','5135','IDR','IDR','IDR');

Delete from enum_text where tagid = 5135 and  enumcode = 'NGN';

Delete from enum_text where tagid = 5136 and  enumcode = 'Asia/Jakarta';
INSERT INTO enum_text (VERSION, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, LANGUAGE, TagName, TagID, EnumCode, EnumValue, DisplayText) VALUES ('1',now(),'system',now(),'system','0','Timezone','5136','Asia/Jakarta','West_Indonesia_Time','West_Indonesia_Time');

Delete from enum_text where tagid = 5136 and  enumcode = 'Asia/Makassar';
INSERT INTO enum_text (VERSION, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, LANGUAGE, TagName, TagID, EnumCode, EnumValue, DisplayText) VALUES ('1',now(),'system',now(),'system','0','Timezone','5136','Asia/Makassar','Central_Indonesia_Time','Central_Indonesia_Time');

Delete from enum_text where tagid = 5136 and  enumcode = 'Asia/Jayapura';
INSERT INTO enum_text (VERSION, LastUpdateTime, UpdatedBy, CreateTime, CreatedBy, LANGUAGE, TagName, TagID, EnumCode, EnumValue, DisplayText) VALUES ('1',now(),'system',now(),'system','0','Timezone','5136','Asia/Jayapura','East_Indonesia_Time','East_Indonesia_Time');
