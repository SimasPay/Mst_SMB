CREATE TABLE service_defualt_config (
  ...
  CONSTRAINT FK_SrvDftCfg_PtnrBySrvPrvdrID FOREIGN KEY (ServiceProviderID) REFERENCES partner(ID),
  CONSTRAINT FK_SrvDftCfg_Service FOREIGN KEY (ServiceID) REFERENCES service(ID)
);
