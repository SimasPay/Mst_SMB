...
CREATE SEQUENCE SUBSCRIBER_UPGRADE_ID_SEQ  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE;

CREATE OR REPLACE TRIGGER SUBSCRIBER_UPGRADE_ID_TRG BEFORE INSERT ON SUBSCRIBER_UPGRADE_DATA
FOR EACH ROW
DECLARE
