CREATE TABLE "KTP_DETAILS" 
   ("ID" NUMBER(19,0) NOT NULL ENABLE, 
	...
	"MOTHERSMAIDENNAME" VARCHAR2(255 CHAR), 
...
ALTER TABLE SUBSCRIBER_MDN ADD  (IDVALIDUNTIL TIMESTAMP, ISIDLIFETIME VARCHAR2(2)) ;
...
INSERT INTO notification (LastUpdateTime,UpdatedBy,CreateTime,CreatedBy,Version,MSPID,Code,CodeName,NotificationMethod,Text,STKML,Language,Status,StatusTime,AccessCode,SMSNotificationCode,CompanyID) VALUES (sysdate,'System',sysdate,'System',0,1,2126,'SubscriberKtpValdiationSuccess',4,'Subscriber KTP Validation Successfull',null,0,0,sysdate,null,null,1);

INSERT INTO notification (LastUpdateTime,UpdatedBy,CreateTime,CreatedBy,Version,MSPID,Code,CodeName,NotificationMethod,Text,STKML,Language,Status,StatusTime,AccessCode,SMSNotificationCode,CompanyID) VALUES (sysdate,'System',sysdate,'System',0,1,2126,'SubscriberKtpValdiationSuccess',4,'Subscriber KTP Validation Successfull',null,1,0,sysdate,null,null,1);

INSERT INTO notification (LastUpdateTime,UpdatedBy,CreateTime,CreatedBy,Version,MSPID,Code,CodeName,NotificationMethod,Text,STKML,Language,Status,StatusTime,AccessCode,SMSNotificationCode,CompanyID) VALUES (sysdate,'System',sysdate,'System',0,1,2127,'SubscriberKtpValdiationFailed',4,'Subscriber KTP Validation Failed',null,0,0,sysdate,null,null,1);

INSERT INTO notification (LastUpdateTime,UpdatedBy,CreateTime,CreatedBy,Version,MSPID,Code,CodeName,NotificationMethod,Text,STKML,Language,Status,StatusTime,AccessCode,SMSNotificationCode,CompanyID) VALUES (sysdate,'System',sysdate,'System',0,1,2127,'SubscriberKtpValdiationFailed',4,'Subscriber KTP Validation Failed',null,1,0,sysdate,null,null,1);
...
INSERT INTO POCKET_TEMPLATE_CONFIG (VERSION,LASTUPDATETIME,UPDATEDBY,CREATETIME,CREATEDBY,SUBSCRIBERTYPE,BUSINESSPARTNERTYPE,KYCLEVEL,COMMODITY,POCKETTYPE,ISSUSPENCEPOCKET,ISCOLLECTORPOCKET,POCKETTEMPLATEID) VALUES (1,SYSDATE,'system',SYSDATE,'system',0,NULL,1,4,6,0,0,(SELECT ID FROM POCKET_TEMPLATE WHERE TYPE = 6 AND BANKACCOUNTCARDTYPE = 1));

INSERT INTO PTC_GROUP_MAPPING (VERSION, LASTUPDATETIME, UPDATEDBY, CREATETIME, CREATEDBY, GROUPID, PTCID ) VALUES (1,SYSDATE,'System',SYSDATE,'System',1,(SELECT ID FROM POCKET_TEMPLATE_CONFIG WHERE KYCLEVEL = 1 AND POCKETTYPE = 6));
