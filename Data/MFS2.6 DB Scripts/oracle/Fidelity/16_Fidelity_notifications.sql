...
update notification set text='Dear $(SenderFirstName) $(SenderLastName), You are currently not registered as a FidelityBank MM user. To Register, Please send your full name to $(CustomerServiceShortCode)' where code = 11;  
...
update notification set text='Dear $(SenderFirstName) $(SenderLastName),Insufficient Funds. Kindly fund your account from an Fidelity agent location and try again.' where code = 16;  
...
update notification set text='Congratulations, You have successfully activated your account, thank you for choosing Fidelity Mobile Money' where code = 52;  
...
update notification set text='Dear $(SenderFirstName) $(SenderLastName), please note that your request to change your FidelityBank MM PIN on $(TransactionDateTime) was not successful. Please try again . For more info, please call $(CustomerServiceShortCode).  TRANS ID $(TransactionID)' where code = 209; 
...
update notification set text='Congratulations, Dear Subscriber, you have been successfully registered for Fidelity Mobile money services. Please use your Activation Code: $(OneTimePin) to activate your account. ' where code = 626; 

update notification set text='Congratulations Dear Subscriber, your account has been successfully upgraded to $(KycLevel) status. Contact us on $(CustomerServiceShortCode) or visit the nearest Fidelity MM agent to learn more.' where code = 627; 
...
update notification set text='Transaction ID: $(TransferID). Dear $(SenderFirstName) $(SenderLastName), you have successfully transferred $(Currency) $(Amount) to $(BankAccountNumber) your account balance is $(CommodityBalanceValue), thank you for choosing Fidelity Mobile Money.' where code = 685; 
...
update notification set text='Dear Mobile User, MSISDN used is currently not registered as a Fidelity Mobile Money subscriber. Please cal $(CustomerServiceShortCode) for more info. ' where code = 671; 

update notification set text='Dear Mobile User, please note that your phone number $(SourceMDN) used is currently not registered as a Fidelity Mobile Money subscriber. Please cal $(CustomerServiceShortCode) for more info.' where code = 672; 

update notification set text='Dear Mobile User, please note that your phone number $(SourceMDN) is currently not registered as a Fidelity Mobile Money subscriber To Register,Please cal $(CustomerServiceShortCode) for more info.' where code = 673; 
