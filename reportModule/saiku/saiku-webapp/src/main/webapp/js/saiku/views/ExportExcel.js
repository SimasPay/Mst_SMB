 ...
 */
var ExportExcel = Modal.extend({
    type: "exportexcel",
    closeText: "ExportExcel",
    
    buttons: [
        { text: "Export", method: "exportExcel" }
    ],
    ...
    initialize: function(args) {
        ...
        this.message =  _.template("<form id='export_excel_form'>" +
    ...
    exportExcel: function(event) {
        ...
        if(reportTitle == ""){
		 ...
		 window.location = Settings.REST_URL +
            ...
            this.query.id + "/export/xls?reportTitle="+reportTitle;
            this.close();
        return false;
    }
}); 
