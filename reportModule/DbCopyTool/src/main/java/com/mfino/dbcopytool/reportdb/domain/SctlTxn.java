...
public class SctlTxn extends TableRow implements java.io.Serializable {
	...
	private String srcCommodityTransferID;
	private String destCommodityTransferID;
	...
	/** minimal constructor */
	public SctlTxn(String sctlid) {
		this.sctlid = sctlid;
	}

	/** full constructor */
	public SctlTxn(String sctlid, String transactionId, Date updateTime,
	...
	public void initialiseRow(Object[] m) {
		...
		this.invoiceNo =  m[++i] != null ? m[i].toString() : "";
		this.ischargeDistributed = (Boolean) m[++i];
		
		this.createTime = (Date)m[++i];
		this.updateTime = (Date) m[++i];
		this.srcCommodityTransferID =  m[++i] != null ? m[i].toString() : "";
		this.destCommodityTransferID =  m[++i] != null ? m[i].toString() : "";
	...
	public String getSrcCommodityTransferID() {
		return srcCommodityTransferID;
	}

	public void setSrcCommodityTransferID(String srcCommodityTransferID) {
		this.srcCommodityTransferID = srcCommodityTransferID;
	}

	public String getDestCommodityTransferID() {
		return destCommodityTransferID;
	}

	public void setDestCommodityTransferID(String destCommodityTransferID) {
		this.destCommodityTransferID = destCommodityTransferID;
	}
