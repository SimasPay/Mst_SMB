...
public class CommodityTransfer extends TableRow implements java.io.Serializable {
	...
	/** minimal constructor */
	public CommodityTransfer(String commodityTransferId) {
		this.commodityTransferId = commodityTransferId;
	}

	/** full constructor */
	public CommodityTransfer(String commodityTransferId, String transactionId,
	...
	public void initialiseRow(Object[] m) {
		...
		this.operatorResponseCode =  m[++i] != null ? m[i].toString() : "";
		transfromRow();
	}
