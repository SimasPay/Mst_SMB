 ...
 */
public class BankSMFailedReport extends OfflineReportBase {

    private static final int NUM_COULMNS = 19;
    private static final String HEADER_ROW = "#,Parent Ref No,Date & Time,Sequence,Transaction Code, Bucket Type, From MDN, " +
...
//        ActivitiesLogDAO activitiesDAO = new ActivitiesLogDAO();
        ...
        try {
            ...
            HibernateUtil.getCurrentSession().getTransaction().rollback();
            log.error("Error in BankSMFailedReport", t);
        }
        return reportFile;
    }
}
