 ...
 * @author Maruthi
 */
public class BankBPRKSReport extends OfflineReportBase{
    ...
    public File run(Date start, Date end, Long companyID) {
        ...
        try {
            ...
            log.info("BPRKSRouting Code: "+ConfigurationUtil.getBPRKSRoutingCode());
            ...
            HibernateUtil.getCurrentSession().getTransaction().rollback();
            log.error("Error in BankBprksReport", t);
        }
        return reportFile;
    }
