 ...
 *
 */
@Service("TransferInquiryHandlerImpl")
public class TransferInquiryHandlerImpl extends FIXMessageHandler implements TransferInquiryHandler{
	...
	//	addCompanyANDLanguageToResult(sourceMDN, result);
		...
		log.info("TransferInquiryHandler destMdn="+destinationMDN+", destPocketCode="+transactionDetails.getDestPocketCode());
