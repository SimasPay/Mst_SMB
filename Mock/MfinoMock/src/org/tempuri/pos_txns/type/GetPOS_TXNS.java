 ...
 */
            ...
            /**
            *  GetPOS_TXNS bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPOS_TXNS
    ...
    public static class Factory{
        ...
        */
        public static GetPOS_TXNS parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPOS_TXNS object =
                new GetPOS_TXNS();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPOS_TXNS".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPOS_TXNS)org.tempuri.pos_txns.type.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
