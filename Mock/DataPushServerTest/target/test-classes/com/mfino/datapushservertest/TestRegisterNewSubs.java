 ...
 * @author admin
 */
public class TestRegisterNewSubs extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TestRegisterNewSubs</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TestRegisterNewSubs at " + request.getContextPath () + "</h1>");
            out.println("<form id='testform' action='TestRegisterNewSubs' method='post'>");
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.print(port.registerNewSubs(val,IMSI,MarketingCatg,Product,FirstName,
