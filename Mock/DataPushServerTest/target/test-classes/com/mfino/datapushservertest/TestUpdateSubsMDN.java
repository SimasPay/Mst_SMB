 ...
 * @author admin
 */
public class TestUpdateSubsMDN extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TestUpdateSubsMDN</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TestUpdateSubsMDN at " + request.getContextPath () + "</h1>");
            out.println("<form id='testform' action='TestUpdateSubsMDN' method='post'>");
            out.println("<input type='text' id='subs' name='subs'>&nbsp&nbspMDN</input></br>");
            out.println("<input type='text' id='newMdn' name='newMdn'>&nbsp&nbspNew MDN</input></br>");
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String newMdn = request.getParameter("newMdn");
            ...
            out.print(port.updateSubsMDN(subs, newMdn));
        }
        catch(Exception e)
        {
