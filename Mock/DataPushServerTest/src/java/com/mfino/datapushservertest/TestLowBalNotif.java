 ...
 * @author admin
 */
public class TestLowBalNotif extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TestLowBalanceNotif</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TestLowBalanceNotif at " + request.getContextPath () + "</h1>");
            out.println("<form id='testform' action='TestLowBalNotif' method='post'>");
            out.println("<input type='text' id='subs' name='subs'>&nbsp&nbspMDN</input></br>");
            out.println("<input type='text' id='notifType' name='notifType'>&nbsp&nbspNotification Type</input></br>");
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.print(port.lowBalNotif(subs, notifType));
        }
        catch(Exception e)
        {
