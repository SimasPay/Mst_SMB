...
public class SuspendSubcriber {
	...
	public static void main(String[] args){
		try{
			...
			System.out.println("Called web service for the to suspend subscriber with msisdn:"+msisdn);
			String result = myService.suspendSubs(msisdn);		
	...
	private static void readPropertieFile() throws FileNotFoundException, IOException{
		...
		prop.load(new FileInputStream("suspendSubscriber.properties"));
