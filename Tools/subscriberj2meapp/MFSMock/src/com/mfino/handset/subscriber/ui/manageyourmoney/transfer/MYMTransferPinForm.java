		...
		if(command == super.mFinoConfigData.backCommand){
			...
			if (pin.getString().equals("")) {
                ...
                if (responseData.getParentTxnId() == null || responseData.getTransferId() == null) {
                	...
                	String sourcePocketString = ConfigurationUtil.POCKET_CODE_EMONEY.equals(mFinoConfigData.getSourcePocketCode()) ? "E-Money Account" : "Bank Account";
                	String destinationPocketString = ConfigurationUtil.POCKET_CODE_EMONEY.equals(mFinoConfigData.getDestinationPocketCode()) ? "E-Money Account" : "Bank Account";
