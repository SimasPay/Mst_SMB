 ...
 *
 */
public class AirtimeTransferAmountForm extends AbstractMfinoConfig implements CommandListener{
	...
	public AirtimeTransferAmountForm(MfinoConfigData mFinoConfigData, Displayable parent){
	...
	public AirtimeTransferAmountForm(MfinoConfigData mFinoConfigData)
	{
		super(mFinoConfigData);
	}
	...
	public void commandAction(Command command, Displayable displayable) {
		if(command == super.mFinoConfigData.backCommand){
			...
			if (amount.getString().equals("")) {
				...
				new AirtimeTransferPinForm(mFinoConfigData, displayable);
			}
		}
