...
public class ChangePin implements CommandListener {
    ...
    public ChangePin(MobileBankingMidlet m, Form pf) {
        ...
        f = new Form("Merchant Change Pin");
...
//                f.addCommand(exitCommand);
    ...
    public void commandAction(Command c, Displayable d) {
        if ((c == sendCommand)) {
            if (sourceMdn.getString().equals("") || oldPin.getString().equals("") || newPin.getString().equals("")) {
                ...
                String url = ConfigurationUtil.getURL() + "SmsServicesServletMA?SMS_sourceMsisdn=" + sourceMdn.getString().trim() +
                        "&SMS_oldPin=" + oldPin.getString().trim() + "&SMS_newPin=" + newPin.getString() + "&SMS_serviceName=change_pin";
                try {
                    processRequest(url);
                } catch (Exception e) {
