 ...
 *
 */
public class MYMTransferAmountForm extends AbstractMfinoConfig implements CommandListener{
	...
	public MYMTransferAmountForm(MfinoConfigData mFinoConfigData, Displayable parent){
	...
	public MYMTransferAmountForm(MfinoConfigData mFinoConfigData)
	{
		super(mFinoConfigData);
	}
	...
	public void commandAction(Command command, Displayable displayable) {
		if(command == super.mFinoConfigData.backCommand){
			...
			if (amount.getString().equals("")) {
				...
				new MYMTransferPinForm(mFinoConfigData, displayable);
			}
		}
