 ...
 *
 */
public class SelfTransferConfirmScreen4 extends AbstractMfinoConfig implements CommandListener {
    ...
    public SelfTransferConfirmScreen4(UserDataContainer mFinoConfigData, Displayable parent, String confirmMessage) {
        ...
        topUpconfirmForm.addCommand(mFinoConfigData.sendCommand);
