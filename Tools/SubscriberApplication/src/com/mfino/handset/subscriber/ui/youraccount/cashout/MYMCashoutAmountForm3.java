 ...
 *
 */
public class MYMCashoutAmountForm3 extends AbstractMfinoConfig implements CommandListener {
    ...
    public MYMCashoutAmountForm3(UserDataContainer mFinoConfigData, Displayable parent) {
        super(mFinoConfigData);
        this.parent = parent;
        display = Display.getDisplay(mFinoConfigData.getMobileBankingMidlet());
        amountForm = new Form("Enter Amount");
        tfAmount = new TextField("Amount", null, 8, TextField.NUMERIC);
    ...
    public MYMCashoutAmountForm3(UserDataContainer mFinoConfigData) {
        super(mFinoConfigData);
    }
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == super.mFinoConfigData.backCommand) {
            ...
            if (ConfigurationUtil.isBlank(tfAmount.getString())) {
                ...
                new MYMCashoutPinForm4(mFinoConfigData, displayable);
            }
