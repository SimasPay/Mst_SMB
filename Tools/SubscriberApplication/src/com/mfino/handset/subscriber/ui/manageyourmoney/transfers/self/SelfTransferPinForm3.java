 ...
 *
 */
public class SelfTransferPinForm3 extends AbstractMfinoConfig implements CommandListener {
    ...
    public SelfTransferPinForm3(UserDataContainer mFinoConfigData, Displayable parent) {
        this(mFinoConfigData, parent, "Enter PIN");
    }

    public SelfTransferPinForm3(UserDataContainer mFinoConfigData, Displayable parent, String pinLabel) {
    ...
    public SelfTransferPinForm3(UserDataContainer mFinoConfigData) {
        super(mFinoConfigData);
    }
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == super.mFinoConfigData.backCommand) {
            ...
            if (ConfigurationUtil.isBlank(tfPin.getString())) {
                ...
                if (!Constants.NOTIFICATIONCODE_TRANSFERINQUIRY_SUCCESS.equals(responseData.getMsgCode())) {
                    ...
                    new SelfTransferConfirmScreen4(mFinoConfigData, displayable, confirm);
                }
            }
