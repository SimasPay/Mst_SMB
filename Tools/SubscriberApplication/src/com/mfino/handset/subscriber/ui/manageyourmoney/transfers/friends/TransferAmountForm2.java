 ...
 *
 */
public class TransferAmountForm2 extends AbstractMfinoConfig implements CommandListener {
    ...
    public TransferAmountForm2(UserDataContainer mFinoConfigData, Displayable parent) {
        super(mFinoConfigData);
        this.parent = parent;
        display = Display.getDisplay(mFinoConfigData.getMobileBankingMidlet());
        amountForm = new Form("Enter Amount");
        amount = new TextField("Amount", "", 8, TextField.NUMERIC);
    ...
    public TransferAmountForm2(UserDataContainer mFinoConfigData) {
        super(mFinoConfigData);
    }
