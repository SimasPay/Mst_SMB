 ...
 *
 */
public class BuyAmountForm2 extends AbstractMfinoConfig implements CommandListener {
    ...
    public BuyAmountForm2(UserDataContainer mFinoConfigData, Displayable parent) {
    ...
    public BuyAmountForm2(UserDataContainer mFinoConfigData) {
        super(mFinoConfigData);
    }
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == super.mFinoConfigData.backCommand) {
            ...
            if (ConfigurationUtil.isBlank(tfAmount.getString())) {
                ...
                new BuyPinForm3(mFinoConfigData, displayable);
            }
