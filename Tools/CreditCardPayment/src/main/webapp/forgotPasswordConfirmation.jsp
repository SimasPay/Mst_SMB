...
<meta http-equiv="Expires" content="0" />
        <title>Selamat Datang di Website Pembayaran Smartfren | Konfirmasi Lupa PIN</title>
						...
						<td class="tbl_login" align="center">
                                                    <%
                                                    	...
                                                    	if ("0".equals(resultCode)) {
                                                    		displayMsg = "Your reset password request has been successful." +
                                            				"<p>Please check your email."; 
                                                    		backButton = "window.location.href='./login.htm'";
                                                    	} else {
                                                    		displayMsg = "There is a problem with your request:<br> " + resultMsg +
