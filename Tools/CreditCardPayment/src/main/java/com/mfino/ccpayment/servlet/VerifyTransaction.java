...
//           if(record!=null&& amt.equals((double)record.getAmount()) &&CmFinoFIX.TransStatus_Requested.equals(record.getTransStatus()) && currencycode.equals(record.getCurrCode()) && sessionid.equals(record.getSessionID())){
           if(record!=null&& amt.compareTo(record.getAmount())==0 &&CmFinoFIX.TransStatus_Requested.equals(record.getTransStatus()) && currencycode.equals(record.getCurrCode()) && sessionid.equals(record.getSessionID())){           
           ...
           log.error("Exception occured while processing verify transaction ",e);
