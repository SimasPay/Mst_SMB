...
public class NSIACCPaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try
        {
            ...
            log.info("Credit Card Payment Servlet : amount " + amount +" mdn "+ mdn +" subscriberid "+ subscriberid +" pocketid "+ pocketid +" description "+ description + " operation " + operation +" billReferenceNumber "+ billReferenceNumber+" sourceIP "+sourceIP);
