 ...
 * @author sasidhar
 */
public class CashInForm extends AbstractMfinoConfig implements CommandListener{
	...
	public CashInForm(MfinoConfigData mFinoConfigData, Displayable parent){
	...
	public CashInForm(MfinoConfigData mFinoConfigData)
	{
		super(mFinoConfigData);
	}
		...
		if(displayable == sourceAccountForm){
			...
			if(command == mFinoConfigData.nextCommand){
	            ...
	            if (responseData.getParentTxnId() == null || responseData.getTransferId() == null) {
	            	...
	            	confirmString = "Do you want to trasfer "+mFinoConfigData.getAmount() + " from your "+sourcePocketString + " to " + mFinoConfigData.getDestinationMdn();
