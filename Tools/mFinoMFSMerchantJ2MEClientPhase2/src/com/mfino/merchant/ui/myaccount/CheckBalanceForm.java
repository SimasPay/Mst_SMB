 ...
 * @author sasidhar
 */
public class CheckBalanceForm extends AbstractMfinoConfig implements CommandListener{
	
	private Displayable parent;
    private Display display;
    
    private Form sourceAccountForm = new Form("Select Source Account");
    private String[] sourceAccountMenu = {Constants.E_MONEY, Constants.BANK, Constants.AIRTIME};
	...
	public CheckBalanceForm(MfinoConfigData mFinoConfigData, Displayable parent){
	...
	public CheckBalanceForm(MfinoConfigData mFinoConfigData)
	{
		super(mFinoConfigData);
	}
	...
	private void setValues(){
        ...
        if (name.equals(Constants.E_MONEY)) {
        	...
        	mFinoConfigData.setSourcePocketCode("-1");
        	mFinoConfigData.setServiceName("checkBalance");
        }
