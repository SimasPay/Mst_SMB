package com.mfino.handset.merchant.midlets;
...
import com.mfino.handset.merchant.ui.MfinoConfig;
import com.mfino.handset.merchant.ui.MobileBankingMenu;
...
public class MobileBankingMidlet extends MIDlet implements CommandListener, MfinoConfig {
    ...
    public void startApp() {
        ...
        try {
			mFinoLogo = Image.createImage("/com/mfino/handset/resources/mfino1.png");
		} catch (IOException e) {
			e.printStackTrace();
		}
