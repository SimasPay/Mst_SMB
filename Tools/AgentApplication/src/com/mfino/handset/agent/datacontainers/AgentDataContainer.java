...
public class AgentDataContainer {
    ...
    private String ResultFormTitle;
    
    public Command nextCommand = new Command("OK", Command.OK, 1);
     ...
     */
    public CustomizedForm getPreviousForm() {
        return previousForm;
    }
     ...
     */
    public void setPreviousForm(CustomizedForm previousForm) {
...
//    }
    ...
    /**
     * @return the ResultFormTitle
     */
    public String getResultFormTitle() {
        return ResultFormTitle;
    }

    /**
     * @param ResultFormTitle the ResultFormTitle to set
     */
    public void setResultFormTitle(String ResultFormTitle) {
        this.ResultFormTitle = ResultFormTitle;
    }
}
