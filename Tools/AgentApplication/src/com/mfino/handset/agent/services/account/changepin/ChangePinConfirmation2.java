 ...
 * @author karthik
 */
public class ChangePinConfirmation2 extends CustomizedForm implements ActionListener, IResponseListener {

    private AgentDataContainer mfinoConfigData;

    public ChangePinConfirmation2(AgentDataContainer mcd) {
        this.mfinoConfigData = mcd;
        this.getStyle().setBgColor(Constants.COLOUR_GRAY);

        this.previousForm = mfinoConfigData.getPreviousForm();

        Command cmd1 = new Command("Yes", 1);
        Command cmd2 = new Command("No", 2);
        ...
        ta.setText("Are you sure you want to change your pin?");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getCommand().getId() == 1) {
            ...
            if (this.previousForm == null) {
                this.previousForm = new ChangepinForm1(mfinoConfigData);
            }
