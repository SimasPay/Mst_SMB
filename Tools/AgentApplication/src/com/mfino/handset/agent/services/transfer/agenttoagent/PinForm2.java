...
public class PinForm2 extends CustomizedForm implements ActionListener, IResponseListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getCommand().getId() == 1) {
            ...
            userAppData.setTransactionName(Constants.TRANSACTION_AGENT_AGENT_TRANSFER_INQUIRY);
            userAppData.setSourcePocketCode(Constants.POCKET_CODE_EMONEY);
            userAppData.setServiceName(Constants.SERVICE_WALLET);
            ...
            if (this.previousForm == null) {
                this.previousForm = new AgentCodeAmountForm1(userAppData);
            }
