package com.mfino.handset.agent.services.account.history;
 ...
 * @author karthik
 */
public class AgentHistoryForm extends CustomizedForm implements ActionListener, IResponseListener {

    AgentDataContainer SubscriberDataContainer;
    CustomTextField tfSourcePin;
    ComboBox cbAccountType;

    public AgentHistoryForm(AgentDataContainer mcd) {
...
//        tfSourcePin.setEditable(false);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getCommand().getId() == 1) {
            ...
            SubscriberDataContainer.setTransactionName(Constants.TRANSACTION_HISTORY);
