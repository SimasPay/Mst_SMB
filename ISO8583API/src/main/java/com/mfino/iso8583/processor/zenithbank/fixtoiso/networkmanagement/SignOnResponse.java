...
public class SignOnResponse implements IFIXtoISOProcessor {

	protected ZenithBankISOMessage isoMsg ;
	
	public SignOnResponse() throws IOException {
