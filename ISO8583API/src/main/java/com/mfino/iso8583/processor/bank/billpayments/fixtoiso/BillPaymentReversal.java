...
public class BillPaymentReversal extends BillPaymentBankRequest implements IFIXtoISOProcessor {

	public BillPaymentReversal() throws IOException {
	...
	public WrapperISOMessage process(CFIXMsg fixmsg) throws Exception {
		...
		CMBillPaymentReversalToBank msg = (CMBillPaymentReversalToBank) fixmsg;
		isoMsg.setProcessingCode(Integer.parseInt(CmFinoFIX.ISO8583_ProcessingCode_Bank_BillPayment_Payment_Reversal));
