...
import com.mfino.iso8583.processor.bank.fixtoiso.TransferInquiry;
...
public class TransferInquiryTest {
	...
	public void test1() throws Exception {
		TransferInquiry bi = new TransferInquiry();

		CMBankRequest br = TestUtils.newBankRequest();
		CMTransferInquiryToBank msg = new CMTransferInquiryToBank();
		msg.copy(br);
