package com.mfino.bayar;

import java.util.HashMap;

import com.mfino.hibernate.Timestamp;

public class CXMLRPCMsg {
	...
	public String getRevCountKey() {
		return (String) xmlMsg.get("revcount");
	}

	public void setRevCount(String revcount) {
		xmlMsg.put("revcount",revcount);
	}
	...
	public Timestamp getOrgTime() {
		return (Timestamp) xmlMsg.get("orgrqtime");
	}

	public void setOrgTime(Timestamp rqtime) {
		xmlMsg.put("orgrqtime",rqtime);
	}
	...
	public HashMap<String, Object> getBillData() {
		return (HashMap<String, Object>)xmlMsg.get("billdata");
	}
	
	public void setBillData(HashMap<String, Object> billdata) {
		xmlMsg.put("billdata",billdata);		
	}
