package com.mfino.hub.xmlrpc.utils;
...
public class StringUtilities {
	...
	public static String getLastNChars(String billID, int N) {
		int length = billID.length();
		if( length < N)
			return leftPadWithCharacter(billID, N, "0");
		else
			return billID.substring(length - N);
