...
/**
 * MfinoBlobTriggersId generated by hbm2java
 */
@Embeddable
public class MfinoBlobTriggersId implements java.io.Serializable {

	private String triggerName;
	private String triggerGroup;

	public MfinoBlobTriggersId() {
	}

	public MfinoBlobTriggersId(String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MfinoBlobTriggersId))
			return false;
		MfinoBlobTriggersId castOther = (MfinoBlobTriggersId) other;
