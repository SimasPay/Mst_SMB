...
/**
 * MfinoTriggerListenersId generated by hbm2java
 */
@Embeddable
public class MfinoTriggerListenersId implements java.io.Serializable {

	private String triggerName;
	private String triggerGroup;
	private String triggerListener;

	public MfinoTriggerListenersId() {
	}

	public MfinoTriggerListenersId(String triggerName, String triggerGroup,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MfinoTriggerListenersId))
			return false;
		MfinoTriggerListenersId castOther = (MfinoTriggerListenersId) other;
