...
/**
 * MfinoFiredTriggers generated by hbm2java
 */
@Entity
@Table(name = "MFINO_FIRED_TRIGGERS")
public class MfinoFiredTriggers implements java.io.Serializable {
	...
	public MfinoFiredTriggers() {
	}

	public MfinoFiredTriggers(String entryId, String triggerName,
