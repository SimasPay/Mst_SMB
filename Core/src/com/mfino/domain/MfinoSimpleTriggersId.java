...
/**
 * MfinoSimpleTriggersId generated by hbm2java
 */
@Embeddable
public class MfinoSimpleTriggersId implements java.io.Serializable {

	private String triggerName;
	private String triggerGroup;

	public MfinoSimpleTriggersId() {
	}

	public MfinoSimpleTriggersId(String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MfinoSimpleTriggersId))
			return false;
		MfinoSimpleTriggersId castOther = (MfinoSimpleTriggersId) other;
