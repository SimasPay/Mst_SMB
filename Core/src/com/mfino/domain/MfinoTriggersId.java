...
/**
 * MfinoTriggersId generated by hbm2java
 */
@Embeddable
public class MfinoTriggersId implements java.io.Serializable {

	private String triggerName;
	private String triggerGroup;

	public MfinoTriggersId() {
	}

	public MfinoTriggersId(String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MfinoTriggersId))
			return false;
		MfinoTriggersId castOther = (MfinoTriggersId) other;
