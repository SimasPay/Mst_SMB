...
/**
 * AddCustomerProductsByMerchant.java
 *
 ...
 */
            ...
            /**
            *  AddCustomerProductsByMerchant bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddCustomerProductsByMerchant
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = addCustomerProductsByMerchant
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.ucitech.neptune.Order[] localOrder ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.ucitech.neptune.Order[]
                           */
                           public  com.ucitech.neptune.Order[] getOrder(){
                               return localOrder;
                           }
                               ...
                               */
                              protected void validateOrder(com.ucitech.neptune.Order[] param){
                              ...
                              * @param param Order
                              */
                              public void setOrder(com.ucitech.neptune.Order[] param){
                             ...
                             * @param param com.ucitech.neptune.Order
                             */
                             public void addOrder(com.ucitech.neptune.Order param){
                                   if (localOrder == null){
                                   localOrder = new com.ucitech.neptune.Order[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localOrder);
                               list.add(param);
                               this.localOrder =
                             (com.ucitech.neptune.Order[])list.toArray(
                            new com.ucitech.neptune.Order[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addCustomerProductsByMerchant",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localOrder!=null){
                                            for (int i = 0;i < localOrder.length;i++){
                                                if (localOrder[i] != null){
                                                 localOrder[i].serialize(new javax.xml.namespace.QName("","order"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static AddCustomerProductsByMerchant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddCustomerProductsByMerchant object =
                new AddCustomerProductsByMerchant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addCustomerProductsByMerchant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddCustomerProductsByMerchant)com.ucitech.neptune.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    list3.add(com.ucitech.neptune.Order.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","order").equals(reader.getName())){
                                                                    list3.add(com.ucitech.neptune.Order.Factory.parse(reader));
                                                        ...
                                                        object.setOrder((com.ucitech.neptune.Order[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.ucitech.neptune.Order.class,
                                                                list3));
