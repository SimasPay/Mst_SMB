 ...
 */
            ...
            /**
            *  QueryMerchants bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryMerchants
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryMerchants",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryMerchants",
    ...
    public static class Factory{
        ...
        */
        public static QueryMerchants parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryMerchants object =
                new QueryMerchants();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryMerchants".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryMerchants)com.ucitech.neptune.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
