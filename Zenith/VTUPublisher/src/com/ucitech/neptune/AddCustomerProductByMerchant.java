...
/**
 * AddCustomerProductByMerchant.java
 *
 ...
 */
            ...
            /**
            *  AddCustomerProductByMerchant bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddCustomerProductByMerchant
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = addCustomerProductByMerchant
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addCustomerProductByMerchant",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static AddCustomerProductByMerchant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddCustomerProductByMerchant object =
                new AddCustomerProductByMerchant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addCustomerProductByMerchant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddCustomerProductByMerchant)com.ucitech.neptune.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
