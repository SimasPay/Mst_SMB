...
import static com.mfino.zenith.iso8583.utils.DateTimeFormatter.getHHMMSS;
import static com.mfino.zenith.iso8583.utils.DateTimeFormatter.getMMDD;
import static com.mfino.zenith.iso8583.utils.DateTimeFormatter.getMMDDHHMMSS;
...
public abstract class ZenithBankRequestProcessor implements IFixToIsoProcessor {
	...
	public ISOMsg process(CFIXMsg fixmsg) throws AllElementsNotAvailableException {
		...
		try {
			isoMsg.set(2, request.getSourceMDN());// 2
	...
	protected String constructDE43(CMBankRequest request) {
		...
		if(request.getServiceChargeTransactionLogID()==null)
			request.setServiceChargeTransactionLogID(999999l);
	...
	public static void main(String[] args) throws Exception {
		...
		ZenithBankRequestProcessor processor = new ZenithBankRequestProcessor() {
		};
