...
//	public static final String	ZENITH_DE123	           = "610500613134021";
	public static final String	ZENITH_DE127_0 	=  "";
	public static final String	ZENITH_DE127_3	= "ZMobileSrc  ZMobileMeSnk470310000820VisaTG      ";
	public static final String  SUCCESS 		= "00";

	public static final String	ZENITH_DE41_BALANCEINQUIRY = "40570009";
	public static final String	ZENITH_DE42_BALANCEINQUIRY = "ZIB405700900001";
	
	public static final String	ZENITH_DE41_MINISTMT	   = "40570009";
	public static final String	ZENITH_DE42_MINISTMT	   = "ZIB405700900001";
	
	public static final String	ZENITH_DE41_SVA_BANK_TRF   = "40570010";
	public static final String	ZENITH_DE42_SVA_BANK_TRF   = "ZIBTRF405700101";
	
	public static final String	ZENITH_DE41_BANK_SVA_TRF   = "40570011";
	public static final String	ZENITH_DE42_BANK_SVA_TRF   = "ZIBTRF405700111";

	/**
	 * DSTV specific values
	 */
	public static final String	ZENITH_DE41_SVA_DSTV_BILLPAY   = "40570012";
	public static final String	ZENITH_DE42_SVA_DSTV_BILLPAY   = "ZIBPYT405700112";

	public static final String	ZENITH_DE41_BANK_DSTV_BILLPAY   = "40570013";
	public static final String	ZENITH_DE42_BANK_DSTV_BILLPAY   = "ZIBPYT405700113";
	
	public static final String	ZENITH_DE98_BANK_DSTV_BILLPAY	   = "ZIBPYT405700112";
	public static final String	ZENITH_DE98_SVA_DSTV_BILLPAY	   = "ZIBPYT405700112";
	...
	public static String getTransactionType(CFIXMsg msg) {
		...
		else if(CMDSTVTransferInquiryToBank.class.equals(msg.getClass())){
			return "30";
		}
