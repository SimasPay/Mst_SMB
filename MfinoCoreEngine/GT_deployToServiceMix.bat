...
del %SERVICEMIX_HOME%\deploy\gt_cashin_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_integration_cashin_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_zenith_sms_configuration.xml
del %SERVICEMIX_HOME%\deploy\gtbank_iso_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_gt_iso_configuration.xml
del %SERVICEMIX_HOME%\deploy\interswitch_cashin_configuration.xml
del %SERVICEMIX_HOME%\deploy\interswitch_cashout_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_integration_cashout_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_gtbank_billpay_configuration.xml
del %SERVICEMIX_HOME%\deploy\mce_gtbank_quickteller_billpay_configuration.xml
del %SERVICEMIX_HOME%\deploy\nibs_cashin_configuration.xml  
...
del %SERVICEMIX_HOME%\deploy\GTSMS-0.1-SNAPSHOT.jar
del %SERVICEMIX_HOME%\deploy\GTISO8583-0.1-SNAPSHOT.jar
...
del %SERVICEMIX_HOME%\deploy\GTBillPayments-0.1-SNAPSHOT.jar
...
del %SERVICEMIX_HOME%\mfino_conf\gt.properties
del %SERVICEMIX_HOME%\mfino_conf\bc2qmap
del %SERVICEMIX_HOME%\mfino_conf\cashinfrontendmap
del %SERVICEMIX_HOME%\mfino_conf\cashoutfrontendmap
...
copy ..\GTBank\GTISO8583\target\GTISO8583-0.1-SNAPSHOT.jar %SERVICEMIX_HOME%\deploy
...
copy ..\GTBank\GTSMS\target\GTSMS-0.1-SNAPSHOT.jar %SERVICEMIX_HOME%\deploy
...
copy ..\GTBank\GTBillPayments\target\GTBillPayments-0.1-SNAPSHOT.jar %SERVICEMIX_HOME%\deploy
...
copy ..\GTBank\GTConfiguration\src\main\jpos\* %SERVICEMIX_HOME%\jpos\deploy\
...
copy ..\GTBank\GTConfiguration\src\main\resources\META-INF\spring\mce_gtbank_sms_configuration.xml %SERVICEMIX_HOME%\deploy\
copy ..\GTBank\GTConfiguration\src\main\resources\META-INF\spring\gtbank_iso_configuration.xml %SERVICEMIX_HOME%\deploy\
copy MCEConfiguration\src\main\resources\META-INF\spring\mce_integration_cashin_configuration.xml %SERVICEMIX_HOME%\deploy\
copy ..\GTBank\GTConfiguration\src\main\resources\META-INF\spring\nibs_cashin_configuration.xml %SERVICEMIX_HOME%\deploy\
...
copy ..\GTBank\GTConfiguration\src\main\resources\META-INF\spring\mce_quickteller_billpay_configuration.xml %SERVICEMIX_HOME%\deploy\
