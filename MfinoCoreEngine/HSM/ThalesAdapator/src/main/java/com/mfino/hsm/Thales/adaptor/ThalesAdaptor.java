...
/**
 * Thales Adapator to talk to HSM, this would be driven by a config file
 * Thales configuration sample file 
 * <HThales-adaptor name='thales-adaptor' class="com.mfino.hsm.Thales.ThalesAdaptor" logger="Q2_thales">
 *   <host>localhost</host>
 *   <port>9991</port>
 *   <keep-alive>yes</keep-alive>
 *   <keep-alive-interval>10000</keep-alive-interval>
 *   <basepath>jpos/cfg/hsm-</basepath>
 *   <in>hthales-send</in>
 ...
 *
 */
public class ThalesAdaptor  extends  QBeanSupport implements Runnable, ThalesAdaptorMBean 
{
       Space sp;
       ThalesCore channel;
       ...
       public void initChannel () throws ConfigurationException 
       {
        ...
        //   channel = newChannel (e, getFactory());
         ...
         if(keepAlive)
         {
           ...
           basePath=persist.getChildTextTrim("basepath");
           channel = new ThalesCore(host, port, basePath,"base", getLog());
       }
         ...
         public void run () {
             ...
             while (running ()){                          
                 try {
                   ...
                   ThalesMsg m = (ThalesMsg) ts.in ("Request");
                   o=m;
                   ...
                   space=true;
                     ...
                     ThalesMsg resp =   (ThalesMsg)channel.command ((ThalesMsg) o);
    ...
    protected void checkConnection () {
          ...
          {
              getLog().warn("checkConnection ThalesAdaptor");
              ISOUtil.sleep(1000);
          }
