...
var SYSTEM_EDIT_SUBSCRIBER_FORM_HIDE_ACCNO = true;
var EMONEY_ENABLED = false;
var IS_EMAIL_MANDATORY = false;
...
mFino.resendOtpCheck = function (record,resendOtpComponent) {
	if(record.data && resendOtpComponent){
		if(record.data.RegistrationMedium != CmFinoFIX.RegistrationMedium.AdminApp){
			resendOtpComponent.hide();
		}
		else{
			resendOtpComponent.show();
		}
	}
};
...
Ext.form.VTypes["tendigitnumberVal"] = /^([0-9]{10}|[0-9]{16})$/;
Ext.form.VTypes["tendigitnumberText"]="should be numeric and exactly 10 or 16 characters";
