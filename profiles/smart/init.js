...
var SYSTEM_DEFAULT_ACCOUNT_NUMBER_MANDATORY = true;
...
Ext.form.VTypes['smarttelcophoneVal'] = /^([1-9])[\d]{3,12}(R\d*)?$/;
...
Ext.form.VTypes['smarttelcophoneAddVal'] = /^([1-9])[\d]{3,12}$/;
Ext.form.VTypes['smarttelcophoneAddMask'] = /[\d]/;
Ext.form.VTypes['smarttelcophoneAdd'] = function(v,field){
	if(!Ext.form.VTypes['smarttelcophoneAddVal'].test(v)) {
		this.smarttelcophoneAddText = "Phone number must not start with 0 and should be 4 to 13 digits long";
		return false;
	}
	var valmdn=/^[6]{1}[2]{1}[0-9]{4,11}$/;
	var mdn = field.getValue();
	if(mdn.length==12 || mdn.length==13)
	{
		if(!valmdn.test(mdn))
		{
			this.smarttelcophoneAddText = "MDN including with 62 should be 6 to 13 digits long";
			return false;
		}
	}
	if(mdn.indexOf('62')== 0){
		if(!valmdn.test(mdn))
		{
			this.smarttelcophoneAddText = "MDN starting with 62 should be 6 to 13 digits long";
			return false;
		}
	}
	return true;    
...
Ext.form.VTypes['smarttelcophoneAddMoreVal'] = /^([1-9])[\d]{3,12}$/;
...
Ext.form.VTypes['smarttelcophoneAddMore'] = function(v, field){
	if(!Ext.form.VTypes['smarttelcophoneAddMoreVal'].test(v)) {
		this.smarttelcophoneAddMoreText = "Phone number must not start with 0 and should be 4 to 13 digits long";
		return false;
	}
	var valmdn=/^[6]{1}[2]{1}[0-9]{4,11}$/;
	var mdn = field.getValue();
	if(mdn.length==12 || mdn.length==13)
	{
		if(!valmdn.test(mdn))
		{
			this.smarttelcophoneAddMoreText = "MDN including 62 should be 6 to 13 digits long";
			return false;
		}
	}
	if(mdn.indexOf('62')== 0){
		if(!valmdn.test(mdn))
		{
			this.smarttelcophoneAddMoreText = "MDN starting with 62 should be 6 to 13 digits long";
			return false;
		}
	}
	return true;    
...
Ext.form.VTypes["tendigitnumberVal"] = /^[0-9]/;
Ext.form.VTypes["tendigitnumberText"]="should be numeric";
