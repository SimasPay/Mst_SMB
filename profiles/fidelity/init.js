...
/*Global Variables*/
var SYSTEM_DEFAULT_CURRENCY = "NGN";
var SYSTEM_DEFAULT_TIMEZONE = "WAT";
var SYSTEM_DEFAULT_KYC = "3";
var EMONEY_ENABLED = true;
var SYSTEM_DEFAULT_ACCOUNT_NUMBER_MANDATORY = false;
var SYSTEM_EDIT_SUBSCRIBER_FORM_HIDE_ACCNO = false;
...
//to add NGN for float account
Ext.form.VTypes["tendigitnumberVal"] = /^[A-Z0-9]{10,14}$/;
Ext.form.VTypes["tendigitnumberText"]="should be alphanumeric and must be 10 to 14 characters long";
Ext.form.VTypes["tendigitnumberMask"]=/[A-Z\d]/;
