...
public class BankCheckBalanceScreen extends Activity
{
	...
	setContentView(R.layout.bank_checkbalance);
	
	SourceMDNET = (EditText)findViewById(R.id.bacbSourceMDNET);
	SourcePINET = (EditText)findViewById(R.id.bacbSourcePINET);
	BankIDET = (EditText)findViewById(R.id.bacbBankIDET);	
	
	ActivateButton = (Button)findViewById(R.id.bacbCheckBalanceButton);
	ActivateButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.bacbBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		params.add(new BasicNameValuePair(Utils.ServiceName,Utils.CheckBalance));
    		...
    		{
                    Toast.makeText(BankCheckBalanceScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(BankCheckBalanceScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
                
                Intent resultIntent  = new Intent(BankCheckBalanceScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	BankCheckBalanceScreen.this.finish();
        }
    };
