...
public class MerchantLastNTxnsScreen extends Activity
{
	...
	setContentView(R.layout.merchant_lastntxns);
	
	SourceMDNET = (EditText)findViewById(R.id.meltSourceMDNET);
	SourcePINET = (EditText)findViewById(R.id.meltSourcePINET);
	
	ActivateButton = (Button)findViewById(R.id.meltLastNTxnsButton);
	ActivateButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.meltBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		{
                    Toast.makeText(MerchantLastNTxnsScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(MerchantLastNTxnsScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
                
                Intent resultIntent  = new Intent(MerchantLastNTxnsScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	MerchantLastNTxnsScreen.this.finish();
