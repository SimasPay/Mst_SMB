...
public class MerchantCheckBalanceScreen extends Activity
{
	...
	setContentView(R.layout.merchant_checkbalance);
	
	SourceMDNET = (EditText)findViewById(R.id.mecbSourceMDNET);
	SourcePINET = (EditText)findViewById(R.id.mecbSourcePINET);
	
	ActivateButton = (Button)findViewById(R.id.mecbCheckBalanceButton);
	ActivateButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.mecbBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		{
                    Toast.makeText(MerchantCheckBalanceScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(MerchantCheckBalanceScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
                Intent resultIntent  = new Intent(MerchantCheckBalanceScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	MerchantCheckBalanceScreen.this.finish();
