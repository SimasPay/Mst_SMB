...
public class SubscriberShareLoadScreen extends Activity
{
	...
	setContentView(R.layout.subscriber_shareload);
	
	SourceMDNET = (EditText)findViewById(R.id.shSourceMDNET);
	SourcePINET = (EditText)findViewById(R.id.shSourcePINET);
	DestMDNET = (EditText)findViewById(R.id.shDestinationMDNET);
	AmountET = (EditText)findViewById(R.id.shAmountET);
	
	ActivateButton = (Button)findViewById(R.id.shShareLoadButton);
	ActivateButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.shBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		params.add(new BasicNameValuePair(Utils.ServiceName,Utils.ShareLoad));
    		...
    		{
                    Toast.makeText(SubscriberShareLoadScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(SubscriberShareLoadScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
                
                Intent resultIntent  = new Intent(SubscriberShareLoadScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	SubscriberShareLoadScreen.this.finish();
        }
    };
