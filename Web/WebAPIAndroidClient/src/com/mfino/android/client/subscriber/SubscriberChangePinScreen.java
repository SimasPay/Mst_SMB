...
public class SubscriberChangePinScreen extends Activity
{
	...
	setContentView(R.layout.subscriber_changepin);
	
	SourceMDNET = (EditText)findViewById(R.id.chSourceMDNET);
	OldPINET = (EditText)findViewById(R.id.chOldPINET);
	NewPinET = (EditText)findViewById(R.id.chNewPinET);
	
	ChangePinButton = (Button)findViewById(R.id.chChangePinButton);
	ChangePinButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.chBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		params.add(new BasicNameValuePair(Utils.SecretAnswer, NewPinET.getText().toString()));
    		...
    		{
                    Toast.makeText(SubscriberChangePinScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(SubscriberChangePinScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }   
                
                Intent resultIntent  = new Intent(SubscriberChangePinScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	SubscriberChangePinScreen.this.finish();
        }
    };
