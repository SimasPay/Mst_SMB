...
public class SubscriberResetPinScreen extends Activity
{
	...
	setContentView(R.layout.subscriber_resetpin);
	
	SourceMDNET = (EditText)findViewById(R.id.reSourceMDNET);
	NewPINET = (EditText)findViewById(R.id.reNewPinET);
	SecretAnswerET = (EditText)findViewById(R.id.reSecretAnswerET);
	
	ActivateButton = (Button)findViewById(R.id.reResetPinButton);
	ActivateButton.setOnClickListener(clickActivate);
	GoBackButton = (Button)findViewById(R.id.reBackButton);
    ...
    {   
        ...
        public void onClick(View v)
        {
    		...
    		{
                    Toast.makeText(SubscriberResetPinScreen.this,"Connection Error",Toast.LENGTH_LONG).show();
                    return;    		    
    		}
                catch(Exception ex)
                {
                    Toast.makeText(SubscriberResetPinScreen.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
            
                Intent resultIntent  = new Intent(SubscriberResetPinScreen.this,com.mfino.android.client.common.ShowResult.class);
                resultIntent.putExtra("result", str);
            	startActivity(resultIntent); 
            
            	SubscriberResetPinScreen.this.finish();
