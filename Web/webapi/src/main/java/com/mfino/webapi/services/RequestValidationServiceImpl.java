...
public class RequestValidationServiceImpl implements RequestValidationService{
	...
	public boolean validateRequest(HttpServletRequest request, ServletOutputStream writer){
		...
		if (StringUtils.isBlank(sourceMDN) && 
						!((serviceName.equals(ServiceAndTransactionConstants.SERVICE_ACCOUNT) && (
								transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_SUBSCRIBER_REGISTRATION_THROUGH_WEB)
								|| transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_PARTNER_REGISTRATION_THROUGH_API) 
								|| transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_GET_PUBLIC_KEY)
								|| transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_GET_PROMO_IMAGE) 
								|| transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_GET_SUBSCRIBER_BY_TOKEN) 
								|| transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_CLOSE_SUBSCRIBER_BY_TOKEN)
								))
						|| (serviceName.equals(ServiceAndTransactionConstants.SERVICE_PAYMENT) && 
								transactionName.equals(ServiceAndTransactionConstants.TRANSACTION_GET_THIRD_PARTY_DATA)))	) {
