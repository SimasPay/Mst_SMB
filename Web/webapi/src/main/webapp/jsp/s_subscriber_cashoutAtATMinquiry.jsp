...
<title>subscriber Cashout AT ATM Inquiry</title>
</head>
<body>
	<center>
		<h1>subscriber Cashout AT ATM Inquiry</h1>
		<form action="../sdynamic" method="POST">
			<input type="hidden" value="Wallet" name="service" /> <input
				type="hidden" value="CashOutAtATMInquiry" name="txnName" />
			<table>
				<tr>
				...
				<tr>
					<td>On Behalf of Phone Number</td>
