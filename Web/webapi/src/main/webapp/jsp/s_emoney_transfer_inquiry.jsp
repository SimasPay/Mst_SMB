...
<title>Transfer Inquiry</title>
</head>
<body>
<center>
<h1>Transfer Inquiry</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="TransferInquiry" name="txnName" />
<table>
	 <tr>
		<td>E-Money Transfer Inquiry</td>
	</tr>
	<tr>
		<td>
			<input type="hidden" name="service" value="Wallet"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
	 ...
	 -->
	<tr>
		<td><input type="hidden" name="sourcePocketCode" value="1" /></td>
	</tr>
	<!-- 
	<tr>
	 ...
	 -->
	<tr>
		<td><input type="hidden" name="destPocketCode" value="1" /></td>
	</tr>
	<tr>
