...
<title>Transfer To Uangku Confirmation</title>
</head>
<body>
<center>
<h1>Transfer To Uangku Confirmation</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="TransferToUangku" name="txnName" />
...
<table>
	...
	<tr>
		...
		<td>
			<input type="text" name="sourcePocketCode" value="2" />
		</td>
		</td>
	</tr>
	<tr>
