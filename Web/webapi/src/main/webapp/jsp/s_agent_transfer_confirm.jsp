...
<title>Agent Transfer confirmation</title>
</head>
<body>
<center>
<h1>Agent Transfer Confirmation</h1>
...
<!-- 	<tr>
		...
		<td><input type="text" name="sourcePocketCode" />(Emoney-1 ,Bank-2, LakuPandia-6)</td>
	</tr>
	<tr>
		<td>DestinationPocketCode</td>
		<td><input type="text" name="destPocketCode" />(Emoney-1 ,Bank-2, LakuPandia-6)</td>
	</tr> -->
	<tr>
		<td>SourcePocketCode</td>
