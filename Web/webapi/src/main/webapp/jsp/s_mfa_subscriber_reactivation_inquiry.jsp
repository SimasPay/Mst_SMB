...
<title>MFA Subscriber Reactivation Inquiry</title>
</head>
<body>
<center>
<h1>MFA Subscriber Reactivation Inquiry</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="Account" name="service" /> 
<input type="hidden" value="Reactivation"	name="txnName" /> 
<table>
	<tr>
	...
	<tr>
		<td><input type="hidden" name="mfaTransaction" value="Inquiry" /></td>
	</tr>
	<tr>
