...
<title>UnRegistered subscriber Cashout Inquiry</title>
</head>
<body>
<center>
<h1>UnRegistered subscriber Cashout Inquiry</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="AgentServices" name="service" /> 
<input type="hidden" value="CashOutInquiryToUnregistered" name="txnName" />
<table>
	<tr>
	...
	<tr>
		<td>secreteCode</td>
		<td><input type="text" name="secreteCode"  value=""/></td>
	</tr>
