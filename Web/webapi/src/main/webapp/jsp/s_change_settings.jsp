...
<title>ChangeSettings</title>
</head>
<body>
<center>
<h1>ChangeSettings</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="Account" name="service" /> 
<input type="hidden" value="ChangeSettings"	name="txnName" /> 
<table>
	<tr>
	...
	<tr>
		<td>language</td>
		<td><input type="text" name="language" value="" />(0 - English, 1 - Bahasa)</td>
	</tr>
