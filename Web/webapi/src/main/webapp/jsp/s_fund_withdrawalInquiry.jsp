...
<title>Fund Withdrawal Inquiry</title>
</head>
<body>
<center>
<h1>Fund Withdrawal Inquiry From Merchant</h1>
<form action="../sdynamic" method="POST">
<input type="hidden" value="Wallet" name="service" /> 
<input type="hidden" value="FundWithdrawalInquiry" name="txnName" />
<table>
	<tr>
	...
	<tr>
		<td>WithdrawalPhoneNumber</td>
		<td><input type="text" name="onBehalfOfMDN" value="" /></td>
	</tr>
	<tr>
		<td>Amount</td>
