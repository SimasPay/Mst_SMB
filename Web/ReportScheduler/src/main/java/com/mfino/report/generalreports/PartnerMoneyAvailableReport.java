...
public class PartnerMoneyAvailableReport extends OfflineReportBase {
	...
	protected File run(Date start, Date end, ReportBaseData basedata) {
		...
		try {
			...
			for(Subscriber subscriber:subscribers){
				...
				Address partnerAddress = subscriber.getAddressBySubscriberAddressID();
				String address = "";
				if(partnerAddress != null)
				{
					address = partnerAddress.getLine1() + " " + partnerAddress.getLine2() + " " + partnerAddress.getCity() + " " + partnerAddress.getCountry() + " " + partnerAddress.getZipCode();
					/*
