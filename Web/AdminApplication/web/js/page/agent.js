...
mFino.page.agent = function(config){
            ...
            },
            {
                ...
                handler : function(){
                    if(!detailsForm.record){
                        ...
                        gridEditForm.setTitle( _("Edit Agent"));
...
//                            }
            ...
            },
            {
                ...
                handler : function(){
                    if(!detailsForm.record){
                        ...
                        gridEditForm.setTitle( _(" Agent Deatls"));
    ...
    searchBox.on("search", function(values){
        ...
        listBox.store.baseParams[CmFinoFIX.message.JSPartner.PartnerTypeSearch._name] = CmFinoFIX.TagID.BusinessPartnerTypeAgent;
    ...
    listBox.on("download", function() {
        ...
        var partnerIdSearch= values[CmFinoFIX.message.JSPartner.PartnerIDSearch];
        var partnerCodeSearch = values[CmFinoFIX.message.JSPartner.PartnerCodeSearch];
        var tradeNameSearch = values[CmFinoFIX.message.JSPartner.TradeNameSearch];
        var authorizedEmailSearch = values[CmFinoFIX.message.JSPartner.AuthorizedEmailSearch];
        var startDateSearch = getUTCdate(values.startDate);
        var endDateSearch = getUTCdate(values.endDate);
        var serviceID = values[CmFinoFIX.message.JSPartner.ServiceIDSearch];
        ...
        queryString += "&"+CmFinoFIX.message.JSPartner.PartnerTypeSearch._name+"="+CmFinoFIX.TagID.BusinessPartnerTypeAgent;
