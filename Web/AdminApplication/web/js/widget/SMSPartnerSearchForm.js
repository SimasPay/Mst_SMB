...
mFino.widget.SMSPartnerSearchForm = function (config) {
    var localConfig = Ext.apply({}, config);
    localConfig = Ext.applyIf(localConfig, {
        labelPad : 10,
        labelWidth : 80,
        frame:true,
        title: _('SMS Partner Search'),
        ...
        items: [
        {
            ...
            anchor :'98%',
            maxLength:255,
            name: CmFinoFIX.message.JSSMSPartner.PartnerNameSearch._name,
            listeners   : {
    ...
    mFino.widget.SMSPartnerSearchForm.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.SMSPartnerSearchForm, Ext.FormPanel, {
    ...
    initComponent : function () {
        ...
        mFino.widget.SMSPartnerSearchForm.superclass.initComponent.call(this);
