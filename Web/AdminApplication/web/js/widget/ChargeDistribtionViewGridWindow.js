...
mFino.widget.ChargeDistribtionViewGridWindow = function (config){
    ...
    mFino.widget.ChargeDistribtionViewGridWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.ChargeDistribtionViewGridWindow, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.ChargeDistribtionViewGridWindow.superclass.initComponent.call(this);

//        this.grid.on("download", function() {
//            var idSearch = this.grid.store.baseParams[CmFinoFIX.message.JSTransactionAmountDistributionLog.ServiceChargeTransactionLogID._name];
//            var queryString;
//            queryString = "dType=bulkUploadEntry";
//            if(idSearch){
//                queryString += "&"+CmFinoFIX.message.JSTransactionAmountDistributionLog.ServiceChargeTransactionLogID._name+"="+idSearch;
//            }
