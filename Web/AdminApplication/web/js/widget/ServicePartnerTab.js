...
mFino.widget.ServicePartnerTab = function(config){
    mFino.widget.ServicePartnerTab.superclass.constructor.call(this, config);
};

Ext.extend(mFino.widget.ServicePartnerTab, Ext.TabPanel, {
...
//            itemId: "sub.service.tab",
        ...
        mFino.widget.ServicePartnerTab.superclass.initComponent.call(this);       
    },
    ...
    setPartnerRecord : function(record){
        ...
        var partnerId = record.data[CmFinoFIX.message.JSPartner.Entries.ID._name];
        var subscriberId = record.data[CmFinoFIX.message.JSPartner.Entries.SubscriberID._name];
        
        // Ticket #222: Getting the MDN.
        var mdn = record.data[CmFinoFIX.message.JSPartner.Entries.MDN._name];
//        var subscriberID = record.data[CmFinoFIX.message.JSSubscriberMDN.Entries.SubscriberID._name];
        var subscriberMDNID = record.data[CmFinoFIX.message.JSPartner.Entries.MDNID._name];
        var tradename =  record.data[CmFinoFIX.message.JSPartner.Entries.TradeName._name];
    ...
    addPocket : function(){
        ...
        if(this.record) {
        	if (this.isInitializedOrActive(this.record)) {
	        	record.data[CmFinoFIX.message.JSPocket.Entries.MDNID._name] = this.record.data[CmFinoFIX.message.JSPartner.Entries.MDNID._name];
	            record.data[CmFinoFIX.message.JSPocket.Entries.SubscriberID._name] = this.record.data[CmFinoFIX.message.JSSubscriberMDN.Entries.SubscriberID._name];
        ...
        if(this.record) {
        	if (this.isInitializedOrActive(this.record)) {
	            record.data[CmFinoFIX.message.JSPartnerServices.Entries.PartnerID._name] 
	                        = this.record.data[CmFinoFIX.message.JSPartner.Entries.ID._name];
	            
	            record.data[CmFinoFIX.message.JSPartnerServices.SubscriberID._name] 
	                        = this.record.data[CmFinoFIX.message.JSPartner.Entries.SubscriberID._name];
	            
	            record.data[CmFinoFIX.message.JSPartnerServices.Entries.PartnerTypeSearch._name] 
	                        = this.record.data[CmFinoFIX.message.JSPartner.Entries.BusinessPartnerType._name];        	
	            
	            this.serviceAddFormWindow.setTitle(_("Add Partner Service for ") + 
	            		this.record.data[CmFinoFIX.message.JSPartner.Entries.TradeName._name]);    
