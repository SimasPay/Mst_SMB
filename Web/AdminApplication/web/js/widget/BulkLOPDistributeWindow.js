...
mFino.widget.BulkLOPDistributeWindow = function (config){
    var localConfig = Ext.apply({}, config);
    localConfig = Ext.applyIf(localConfig, {
        modal:true,
        title : _("Bulk LOP Distribute"),
        layout:'fit',
        floating: true,
        width:360,
        height:250,
    ...
    mFino.widget.BulkLOPDistributeWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.BulkLOPDistributeWindow, Ext.Window, {
    initComponent : function(){
        ...
        this.form = new Ext.form.FormPanel({
            ...
            },
            {
                ...
                labelSeparator :'',                
                name: CmFinoFIX.message.JSBulkLOP.Entries.MDN._name
            },
            {
                xtype : 'displayfield',
...
//            }
        ...
        mFino.widget.BulkLOPDistributeWindow.superclass.initComponent.call(this);
    },
    ...
    ok : function(){
        var msg= new CmFinoFIX.message.JSBulkLOPDistribute();
        msg.m_pLOPID = this.record.get(CmFinoFIX.message.JSBulkLOP.Entries.ID._name);
        msg.m_pDestMDN = this.record.get(CmFinoFIX.message.JSBulkLOP.Entries.MDN._name);
        msg.m_pAmount = this.record.get(CmFinoFIX.message.JSBulkLOP.Entries.AmountDistributed._name);
        msg.m_pPin = "";
