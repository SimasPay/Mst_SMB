...
mFino.widget.FormWindowForPartnerService = function (config){
    ...
    mFino.widget.FormWindowForPartnerService.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.FormWindowForPartnerService, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.FormWindowForPartnerService.superclass.initComponent.call(this);
    ...
    apply : function(isCloseWindow){
        if(this.form.getForm().isValid()){
        	var checkSettlementConfigs = this.form.settlementConfigGrid.checkSettlementConfigs();
			if((checkSettlementConfigs != 1) && (EMONEY_ENABLED)) {
        		return;
        	} 
