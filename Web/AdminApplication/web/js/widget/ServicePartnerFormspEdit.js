...
mFino.widget.ServicePartnerFormspEdit = function (config) {
    ...
    mFino.widget.ServicePartnerFormspEdit.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.ServicePartnerFormspEdit, Ext.form.FormPanel, {
...
/*                           {
        ...
        mFino.widget.ServicePartnerFormspEdit.superclass.initComponent.call(this);
...
//            listeners: {
//                check: function() {
//                    this.findParentByType("ServicePartnerFormspEdit").onSelfSuspendClick();
//                }
//            }
//        },
        {
...
Ext.reg("ServicePartnerFormspEdit", mFino.widget.ServicePartnerFormspEdit);
