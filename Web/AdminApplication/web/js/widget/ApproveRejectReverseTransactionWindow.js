...
mFino.widget.ApproveRejectReverseTransactionWindow = function (config){
    var localConfig = Ext.apply({}, config);
    localConfig = Ext.applyIf(localConfig, {
        modal:true,
        title : _("Approve/Reject Reverse Transaction Request"),
        layout:'fit',
        floating: true,
        width:330,
        height:260,
    ...
    mFino.widget.ApproveRejectReverseTransactionWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.ApproveRejectReverseTransactionWindow, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.ApproveRejectReverseTransactionWindow.superclass.initComponent.call(this);
    },
    ...
    ok : function(){
        ...
        if(this.form.getForm().isValid()){
            var msg = new CmFinoFIX.message.JSReverseTransactionApproveReject();
            msg.m_pServiceChargeTransactionLogID = this.record.data[CmFinoFIX.message.JSServiceChargeTransactions.Entries.ID._name];
