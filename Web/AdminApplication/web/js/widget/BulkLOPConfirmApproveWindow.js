...
mFino.widget.BulkLOPConfirmApproveWindow = function (config){
    ...
    mFino.widget.BulkLOPConfirmApproveWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.BulkLOPConfirmApproveWindow, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.BulkLOPConfirmApproveWindow.superclass.initComponent.call(this);
    },
    ...
    ok : function(){
        ...
        record.beginEdit();        
        record.set(CmFinoFIX.message.JSBulkLOP.Entries.Status._name, CmFinoFIX.LOPStatus.Approved);
        record.endEdit();
        if(record.store){
            if(record.phantom){
