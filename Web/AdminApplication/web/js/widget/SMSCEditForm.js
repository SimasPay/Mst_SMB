...
mFino.widget.SMSCEditForm = function (config) {
    ...
    mFino.widget.SMSCEditForm.superclass.constructor.call(this, localConfig);   
};

Ext.extend(mFino.widget.SMSCEditForm, Ext.FormPanel, {
    initComponent : function () {
        ...
        mFino.widget.SMSCEditForm.superclass.initComponent.call(this);
...
Ext.reg("smsceditform", mFino.widget.SMSCEditForm);
