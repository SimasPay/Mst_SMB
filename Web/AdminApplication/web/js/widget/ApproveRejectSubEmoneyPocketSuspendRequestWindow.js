...
mFino.widget.ApproveRejectSubEmoneyPocketSuspendRequestWindow = function (config){
    var localConfig = Ext.apply({}, config);
    localConfig = Ext.applyIf(localConfig, {
        modal:true,
        title : _("Approve/Reject Subscriber Emoney pocket Suspense Request"),
        layout:'fit',
        floating: true,
        width:400,
        height:260,
    ...
    mFino.widget.ApproveRejectSubEmoneyPocketSuspendRequestWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.ApproveRejectSubEmoneyPocketSuspendRequestWindow, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.ApproveRejectSubEmoneyPocketSuspendRequestWindow.superclass.initComponent.call(this);
    },
...
Ext.reg("ApproveRejectSubEmoneyPocketSuspendRequestWindow", mFino.widget.ApproveRejectSubEmoneyPocketSuspendRequestWindow);