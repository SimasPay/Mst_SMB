...
mFino.widget.FormWindowForTransactionCharge = function (config){
    ...
    mFino.widget.FormWindowForTransactionCharge.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.FormWindowForTransactionCharge, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.FormWindowForTransactionCharge.superclass.initComponent.call(this);
    ...
    apply : function(isCloseWindow){
        if(this.form.getForm().isValid()){
        	var nonPartnerCount = this.form.sharePartnerGrid.onlyOneNonPartner();
        	if (nonPartnerCount === -1) {
        		return;
        	}
        	var validationResult = this.form.sharePartnerGrid.validateChargeShareGrid();
