 ...
 */
mFino.widget.ServicePartnerList = function (config) {
...
//        pressed: true,
    ...
    if(mFino.auth.isEnabledItem('servicepartnerlist.download.excel')){
		sbun.show();
    }
	else{
		sbun.hide();
    ...
    if(!localConfig.store){
        localConfig.store = new FIX.FIXStore(config.dataUrl, CmFinoFIX.message.JSPartner);
    }
    ...
    localConfig = Ext.applyIf(localConfig, {
       ...
       // title: _("Partner Search Results "),
        ...
        columns: [
        {
            ...
            resizable : false,
            menuDisabled : true,
            dataIndex: CmFinoFIX.message.JSPartner.Entries.ID._name,
            renderer : function (value,p,r){
                var m = CmFinoFIX.message.JSPartner.Entries;
                var image;
    ...
    mFino.widget.ServicePartnerList.superclass.constructor.call(this, localConfig);
    this.getBottomToolbar().add('->',sbun);
    };

Ext.extend(mFino.widget.ServicePartnerList, Ext.grid.GridPanel, {
    initComponent : function () {
        ...
        mFino.widget.ServicePartnerList.superclass.initComponent.call(this);
    },
