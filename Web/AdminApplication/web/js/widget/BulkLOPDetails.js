...
mFino.widget.BulkLOPDetails = function (config)
{
    ...
    mFino.widget.BulkLOPDetails.superclass.constructor.call(this, localConfig);
};


Ext.extend(mFino.widget.BulkLOPDetails , Ext.form.FormPanel, {
    initComponent : function () {
        this.labelWidth = 120;
        this.labelPad = 20;
        mFino.widget.BulkLOPDetails.superclass.initComponent.call(this);
    },
...
Ext.reg("bulklopdetails", mFino.widget.BulkLOPDetails);
