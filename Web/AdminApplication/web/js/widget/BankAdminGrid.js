 ...
 */
mFino.widget.BankAdminGrid = function (config) {
    var localConfig = Ext.apply({}, config);
    if(!localConfig.store){
        localConfig.store = new FIX.FIXStore(config.dataUrl, CmFinoFIX.message.JSBankAdmin);
    }
...
//    });
    ...
    mFino.widget.BankAdminGrid.superclass.constructor.call(this, localConfig);
   // this.getBottomToolbar().add('->',dbun);
};

Ext.extend(mFino.widget.BankAdminGrid, Ext.grid.GridPanel, {
    initComponent : function () {
        ...
        mFino.widget.BankAdminGrid.superclass.initComponent.call(this);
    },
...
Ext.reg("bankadmingrid", mFino.widget.BankAdminGrid);
