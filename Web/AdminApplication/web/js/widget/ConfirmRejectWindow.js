...
mFino.widget.ConfirmRejectWindow = function (config){
    ...
    mFino.widget.ConfirmRejectWindow.superclass.constructor.call(this, localConfig);
};

Ext.extend(mFino.widget.ConfirmRejectWindow, Ext.Window, {
    initComponent : function(){
        ...
        mFino.widget.ConfirmRejectWindow.superclass.initComponent.call(this);
    },
    ...
    ok : function(){
      var record = this.record;
        record.beginEdit();
        record.set(CmFinoFIX.message.JSLOP.Entries.Status._name, CmFinoFIX.LOPStatus.Rejected);
        record.endEdit();
        if(record.store){
            if(record.phantom){
