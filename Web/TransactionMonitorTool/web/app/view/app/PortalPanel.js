/**
 * @class Mfino.view.app.PortalPanel
 * @extends Ext.panel.Panel
 * A {@link Ext.panel.Panel Panel} class used for providing drag-drop-enabled portal layouts.
 */
Ext.define('Mfino.view.app.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: ['Mfino.view.app.PortalColumn'],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('Mfino.view.app.PortalDropZone', this, this.dropConfig);
    },
