 ...
 *
 */
public class AtppEventProcessingServiceImpl extends BillPaymentsBaseServiceImpl implements BillPayEventProcessingService {
	...
	public MCEMessage processEvent(@Body MCEMessage mceMessage, @Header("eventContext") String eventContext) {
		log.info("AtppEventProcessingServiceImpl : processEvent BEGIN eventContext=" + eventContext + "mceMessage="+mceMessage);
