...
public class GetLastTrxnsFromGTProcessor implements IGTBankISOtoFixProcessor {
	...
	public static void main(String[] args) throws Exception {
		...
		GetLastTrxnsFromGTProcessor processor = new GetLastTrxnsFromGTProcessor();
