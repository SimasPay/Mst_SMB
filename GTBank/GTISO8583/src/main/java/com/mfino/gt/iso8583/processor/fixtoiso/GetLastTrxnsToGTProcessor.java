...
public class GetLastTrxnsToGTProcessor extends GTBankRequestProcessor {

	public GetLastTrxnsToGTProcessor() {
		try {
			isoMsg.setMTI("0200");
		}
	...
	public ISOMsg process(CFIXMsg fixmsg) throws AllElementsNotAvailableException {
		...
		try {
			isoMsg.set(2, constantFieldsMap.get("2"));// msg.getSourceCardPAN()
