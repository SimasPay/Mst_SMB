 ...
 *
 */
public class BillPayInquiryProcessor extends BillPaymentsBaseServiceImpl implements BSIMProcessorNew {
	...
	public MCEMessage constructRequestMessage(MCEMessage mceMessage){
		...
		replyMessage.setDestinationQueue("jms:bsimBillPayInquiryResponseQueue?disableReplyTo=true");
	...
	private void recordOperatorResponseCode(Long sctlId, String de39){
		/*
		 * bsim specific req (smart ticket #1024) to display the DE39 value in both Admin Application and offline reports.
