 ...
 * 
 */
public class FlashizISOUtil extends BaseISOUtil implements ISOUtil {
	...
	public ISOMsg getEchoMessage() throws ISOException {
		...
		// for now
		Long de11 = (Long.valueOf(DateTimeFormatter.getHHMMSS(ts)))+10;
		isoMsg.set(11, String.valueOf(de11));// 11
		isoMsg.set(33, "881");
