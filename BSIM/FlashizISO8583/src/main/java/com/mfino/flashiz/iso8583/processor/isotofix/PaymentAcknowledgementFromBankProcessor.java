...
public class PaymentAcknowledgementFromBankProcessor implements FlashizISOtoFixProcessor{
	...
	public CFIXMsg process(ISOMsg isoMsg, CFIXMsg request) throws InvalidIsoElementException {
		...
		CMPaymentAcknowledgementToBankForBsim toBank = (CMPaymentAcknowledgementToBankForBsim)request;
		CMPaymentAcknowledgementFromBankForBsim fromBank = new CMPaymentAcknowledgementFromBankForBsim();
