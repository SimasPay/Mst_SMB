 ...
 *
 */
public class InterBankTransferInquiryFromBankProcessor implements BSMPPOBISOtoFixProcessor {
	...
	public CFIXMsg process(ISOMsg isoMsg, CFIXMsg request) throws InvalidIsoElementException {
		...
		if(isoMsg.hasField(48))
		{
			...
			fromBank.setBankName(destinationbankbranch);
		...
		fromBank.setReceiveTime(DateTimeUtil.getLocalTime());
		toBank.setReceiveTime(DateTimeUtil.getLocalTime());
