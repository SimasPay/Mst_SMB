package com.mfino.bsm.ppob.iso8583.processor.fixtoiso.networkmanagement;

import org.jpos.iso.ISOException;
import org.jpos.iso.ISOMsg;

import com.mfino.bsm.ppob.iso8583.processor.fixtoiso.BankRequestProcessor;
...
public class SignOffResponse extends BankRequestProcessor {

	protected ISOMsg	isoMsg;

	public SignOffResponse() throws Exception {
		isoMsg.setMTI("0800");
	}
