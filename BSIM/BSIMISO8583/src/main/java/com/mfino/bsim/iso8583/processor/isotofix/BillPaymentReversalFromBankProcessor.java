...
public class BillPaymentReversalFromBankProcessor implements BSIMISOtoFixProcessor {

	@Override
	public CFIXMsg process(ISOMsg isoMsg, CFIXMsg request) throws InvalidIsoElementException {

		CMBSIMBillPaymentReversalFromBank response = new CMBSIMBillPaymentReversalFromBank();
		CMBSIMBillPaymentReversalToBank toBank = (CMBSIMBillPaymentReversalToBank) request;
