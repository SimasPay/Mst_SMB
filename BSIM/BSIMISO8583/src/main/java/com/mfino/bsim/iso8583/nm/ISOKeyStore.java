...
public class ISOKeyStore {
	...
	private static HashMap<String, String> keyStoreHashMap;
	...
	private ISOKeyStore(String filePath, String password, String keyStoreType) throws Exception {
		...
		try {
			...
			log.info("key is stored at " + filePath);
	...
	public static ISOKeyStore newInstance(String keyStoreFile, String password, List<String> macKeys) throws Exception {
		if (isoKeyStore == null) {
			...
			setKeyStoreHashMap(new HashMap<String, String>());
	...
	private void storeMasterKey() throws Exception {
		...
		log.info("storing the master key-->" + masterkey );
		storeKey("MasterKey", masterkey);
		getKeyStoreHashMap().put("MasterKey", masterkey);
	}
	...
	synchronized public void storeWorkingKey(String workingkey) throws Exception {
		...
		getKeyStoreHashMap().put("WorkingKey", workingkey);
	}

	public String getWorkingKey() throws Exception {
...
/*
		...
		*/
		getKeyStoreHashMap().put(keyName, hexEncodedKey);
		return true;
	}
	...
	private String retrieveKey(String keyName) {
/*
		SecretKey ske = null;
		try {
		...
		*/
		return getKeyStoreHashMap().get(keyName);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		ISOKeyStore store = ISOKeyStore.newInstance("D:\\KeyStore", "mFino260", list);
	...
	public static HashMap<String, String> getKeyStoreHashMap() {
		return keyStoreHashMap;
	}

	public static void setKeyStoreHashMap(HashMap<String, String> keyStoreHashMap) {
		ISOKeyStore.keyStoreHashMap = keyStoreHashMap;
	}
