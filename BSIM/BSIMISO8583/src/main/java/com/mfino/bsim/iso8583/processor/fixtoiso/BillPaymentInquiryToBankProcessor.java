...
public class BillPaymentInquiryToBankProcessor extends BankRequestProcessor{
	
	private Set<String> offlineBillers;
	
	public BillPaymentInquiryToBankProcessor() {
		try{
			isoMsg.setMTI("0200");
		}
	...
	public ISOMsg process(CFIXMsg fixmsg){
		CMBSIMBillPaymentInquiryToBank request = (CMBSIMBillPaymentInquiryToBank)fixmsg;
