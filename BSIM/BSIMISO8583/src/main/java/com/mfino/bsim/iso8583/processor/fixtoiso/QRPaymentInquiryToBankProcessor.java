...
public class QRPaymentInquiryToBankProcessor extends BankRequestProcessor {

	private Set<String> offlineBillers;

	public QRPaymentInquiryToBankProcessor() {
		try{
			isoMsg.setMTI("0200");
		}
	...
	public ISOMsg process(CFIXMsg fixmsg){
		CMQRPaymentInquiryToBank request = (CMQRPaymentInquiryToBank)fixmsg;
	...
	private String constructDE63(CMQRPaymentInquiryToBank request) {
