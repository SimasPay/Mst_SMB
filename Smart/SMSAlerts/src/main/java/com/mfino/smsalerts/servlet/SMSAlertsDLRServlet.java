...
public class SMSAlertsDLRServlet extends HttpServlet {
	...
	private static Logger log = LoggerFactory.getLogger(SMSAlertsDLRServlet.class);   
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			SMSTransactionsLogDAO logDAO = DAOFactory.getInstance().getSMSTransactionsLogDAO();
