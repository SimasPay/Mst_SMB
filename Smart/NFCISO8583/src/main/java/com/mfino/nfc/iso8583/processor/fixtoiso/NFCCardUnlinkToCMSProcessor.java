...
public class NFCCardUnlinkToCMSProcessor extends NFCRequestProcessor {

	public NFCCardUnlinkToCMSProcessor() {
		try {
			isoMsg.setMTI("0200");
		}
	...
	public ISOMsg process(CFIXMsg fixmsg) throws AllElementsNotAvailableException {
		...
		CMNFCCardUnlinkToCMS request = (CMNFCCardUnlinkToCMS) fixmsg;
	...
	public static void main(String[] args) throws Exception {
		...
		NFCCardUnlinkToCMSProcessor toZ = new NFCCardUnlinkToCMSProcessor();
