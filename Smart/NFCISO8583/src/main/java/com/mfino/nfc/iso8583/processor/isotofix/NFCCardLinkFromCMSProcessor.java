...
import com.mfino.nfc.iso8583.AdditionalAmounts;
...
public class NFCCardLinkFromCMSProcessor implements NFCISOtoFixProcessor {

	@Override
	public CFIXMsg process(ISOMsg isoMsg, CFIXMsg request) throws InvalidIsoElementException{

		CmFinoFIX.CMNFCCardLinkFromCMS response = new CmFinoFIX.CMNFCCardLinkFromCMS();
		CMNFCCardLinkToCMS toBank = (CMNFCCardLinkToCMS) request;
