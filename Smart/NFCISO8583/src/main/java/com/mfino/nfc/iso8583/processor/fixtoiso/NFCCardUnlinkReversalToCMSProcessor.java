...
public class NFCCardUnlinkReversalToCMSProcessor extends NFCRequestProcessor {

	public Log log = LogFactory.getLog(this.getClass());
	
	public NFCCardUnlinkReversalToCMSProcessor() {
		try {
			isoMsg.setMTI("0400");
		}
	...
	public ISOMsg process(CFIXMsg fixmsg) throws AllElementsNotAvailableException {
		...
		CMNFCCardUnlinkReversalToCMS msg = (CMNFCCardUnlinkReversalToCMS)fixmsg;
		...
		try {
			...
			log.error("NFCCardUnlinkReversalToCMSProcessor :: process ", ex);
		}catch (Exception e) {
			log.error("NFCCardUnlinkReversalToCMSProcessor :: process ", e);
		}
		return isoMsg;
	}
}
