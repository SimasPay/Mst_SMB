...
public class NFCCardUnlinkFromCMSProcessor implements NFCISOtoFixProcessor {

	@Override
	public CFIXMsg process(ISOMsg isoMsg, CFIXMsg request) throws InvalidIsoElementException{

		CmFinoFIX.CMNFCCardUnlinkFromCMS response = new CmFinoFIX.CMNFCCardUnlinkFromCMS();
		CMNFCCardUnlinkToCMS toBank = (CMNFCCardUnlinkToCMS) request;
