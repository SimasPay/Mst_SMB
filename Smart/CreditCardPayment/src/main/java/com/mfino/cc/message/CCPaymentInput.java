...
public final class CCPaymentInput {
    ...
    public CCPaymentInput() {
        ...
        paymentMethod = ConfigurationUtil.getCreditcardPaymentMethod();
        currencyCode = ConfigurationUtil.getCreditcardCurrencyCode();
        transactionPwd = ConfigurationUtil.getCreditcardTransactionPassword();
        returnURL = ConfigurationUtil.getCreditcardReturnURL();
        postURL = ConfigurationUtil.getCreditcardGatewayURL();
        if(ConfigurationUtil.getCreditcardGatewayName().equalsIgnoreCase("NSIAPAY")){
        nsiachainnum = ConfigurationUtil.getCreditcardChainNum();
        nsiaCurrency = ConfigurationUtil.getCreditcardCurrency();
        nsiapurchaseCurrency = ConfigurationUtil.getCreditcardPurchaseCurrency();
        nsiaacquireBin = ConfigurationUtil.getCreditcardAcquirerBin();
        nsiapassword = ConfigurationUtil.getCreditcardPassword();
        nsiaType = ConfigurationUtil.getCreditcardNSIAType();
