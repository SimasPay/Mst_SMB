...
<%@page import="com.mfino.uicore.service.UserService"%>
...
<%
 	...
 	if (request.getAttribute("responsecode") != null) {
 		...
 		if (responseCode.equals("3")) {
 			disabled = "disabled='true'";
 			submitbut = "disabled='true'";
 			errorMsg = "Permintaan Anda tidak bisa diproses, silakan coba lagi";
 		}
 	}
 %>
 <br>
  <h2><font color="#666666">Ubah Email ID Anda</h2>
...
<table align="center" width="460" border="0" cellpadding="5"
	...
	<tr id="enteremail" style="display: none">
		<td id="title_order" colspan="2" valign="top" align="left"> Masukan Email 
          ID baru Anda. <BR>
	...
	<tr id="entercode" style="display: none">
		<td id="title_order" colspan="2" valign="top" align="left"> Masukan kode 
          acak yang telah dikirim ke nomor Smartfren Anda<BR>
		<span class="gaia cca al"><b><font color="#999999"
			size="-2"><em><font color="#666666" size="2">(Please enter scramble 
          code sent to your Smartfren number)</font></em></font></b></span></td>
	</tr>
