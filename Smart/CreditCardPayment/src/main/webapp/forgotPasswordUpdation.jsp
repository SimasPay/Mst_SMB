...
<form name="forgotPasswordUpdation" id="forgotPasswordUpdation" action="ForgotPasswordUpdationServlet" onsubmit="return $('#forgotPasswordUpdation').valid();" method="POST">
   <table align="center" width="460" border="0" cellpadding="5" cellspacing="0" style="background:#fff url(images/m06.png) bottom no-repeat;">
					<tr>
						...
						<h2>Ganti Login PIN</h2>
        </font>
        <em><font color="#666666"><font size="-1">Change Login PIN</font></em></font> 
        <br/></td></tr>
	  <TR><TD></TD></TR>
      ...
      <td align="left" colspan="2" id="title_order")>Masukkan Login PIN baru Anda<font color="#666666" size="-1"> 
        <br>
        <em>(Please enter your new Login PIN)</em></font></td>
                      </tr>
                      <tr> 
      ...
      <td align="left" valign="top" class = "tbl_row2" nowrap="nowrap"> Login 
        PIN Baru<font color="#FF0000">*</font><font color="#999999" size="-2"><em>/New 
        Login PIN </em></font></td>
                        <td class = "tbl_row2">
                                                                    <div>
      ...
      <td align="left" valign="top" nowrap="nowrap" class = "tbl_row2"> Ulangi 
        Login PIN Baru Anda<font color="#FF0000">* <BR>
        </font><em><font color="#999999" size="-2">/Re-enter your new Login PIN</font></em></td>
                        <td class = "tbl_row2">
                                                                    <div>
