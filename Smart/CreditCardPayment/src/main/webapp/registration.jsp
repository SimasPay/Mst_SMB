...
<br>
  <table width = "845" align = "center">
    <Tr> 
      <Td> <a href="http://www.smartfren.com"><img src="./images/smartfren-logo.png" style="border-style: none"></a> 
      </Td>
    </Tr>
  </table>
  <br>
...
<br>
    <table width="680px" border="0" cellpadding="5" cellspacing="0" style="background:#fff url(images/m09.png) bottom no-repeat;">
      <tr> 
        <td align="left" colspan="2"> <strong><font color="#FF0000" size="5">Harap 
          lengkapi data dibawah ini untuk registrasi</font></strong><br> <span class="gaia cca blue">Kolom 
          yang diberi tanda <span class="gaia cca red">*</span> wajib dilengkapi 
          <br>
          <font color="#666666" size="-1"><em>(Please Provide below details to 
          register, fields mark with * are mandatory)</em></font></span> </td>
      </tr>
      <tr> 
        <td colspan="2" align="left" class="tbl_row2"><br> <span id="title_order">Informasi 
          User <b><span class="gaia cca red"><em><font color="#666666" size="-1">/User 
          Information</font></em></span></b></span> </td>
      </tr>
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="username" id="username"
                    size="30" type="text" disabled="disabled" value=<%=mdn %>>
          </div>
          <input name="username" id="username"
      ...
      <tr> 
        <td align="left" class="tbl_row2" width="40%"><b>Login PIN<span class="gaia cca red">*</span></b></td>
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="confirmPassword"
                    id="confirmPassword" size="30" type="password">
          </div></td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2" width="40%" valign="top"><b>Email<span class="gaia cca red">*</span></b></td>
        <td align="left" class="tbl_row2" width="60%"> <div style="display: block;"> 
            <input name="email" id="email" size="30"
                                            type="text">
            <span class="gaia cca cmt">contoh:<i>username@email.com</i></span> 
          </div></tr>
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%" valign="top"> <input name="dob" id="dob" size="30" type="text"> 
...
<td colspan="2">&nbsp;</td>
      ...
      <tr> 
        <td align="left" class="tbl_row2" width="40%"><b>Pertanyaan Rahasia<span class="gaia cca red">*</span></b> 
          ...
          Question </font></em></span></b><br /> <span class="gaia cca cmt">(pertanyaan 
          keamanan untuk lupa password)</span> </td>
...
-->
            ...
            <select id="securityQuestion"
              ...
              <option value="choosequestion" style="font-style: italic;"> Choose 
              a question ...</option>
              <option value="What is your favorite color?">What is your favorite 
              color?</option>
              <option
                            value="What is the name of your best friend from chidhood?">What 
              is the name of your best friend from chidhood?</option>
              <option value="What is your favorite food?">What is your favorite 
              food?</option>
              <option
                            value="Who is your favorite movie star of all time? ">Who 
              is your favorite movie star of all time?</option>
              <option value="Where was your father born? ">Where was your father 
              born?</option>
              <option value="Where was your mother born? ">Where was your mother 
              born?</option>
...
-->
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <input name="securityAnswer" id="securityAnswer" size="50" autocomplete="off" type="text"> 
        </td>
      </tr>
      ...
      <tr> 
        <td colspan="2" id="title_order" align="left"><p><span class="gaia cca blue"><font colspan="2" id="title_order">Anda 
            diperbolehkan untuk mendaftarkan 2 nomor Smartfren lainnya untuk menerima 
            pembayaran kartu kredit</font></span> <br>
            <span class="gaia cca blue"><font colspan="2"><b><span class="gaia cca red"><em><font color="#666666" size="-1">/You 
            can enroll 2 more Smartfren number to accept credit card payment</font></em></span></b></font></span></p></td>
      </tr>
      <tr> 
        <td align="left"  class="tbl_row2"><b>Nomor Tujuan Default*<span class="gaia cca red"><em><font color="#999999" size="-2">/Default 
          Destination Number</font></em></span></b></td>
        <td><input name="destination1" id="destination13"
                    size="30" type="text" disabled="disabled" value=<%=mdn %>></td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2"><b>Tambah Nomor Smartfren<span class="gaia cca red"><em><font color="#999999" size="-2">/Add 
          Smartfren Number</font></em></span></b></td>
        <td align="left" class="tbl_row2"> <div> 
            <input name="addmdn" id="addmdn" class="bttn_adddest" value="" type="button">
          </div></td>
      </tr>
...
<input type="hidden" name="numOfCards" id="numOfCards" value="1">
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <input name="f6" id="f6" size="30" type="text"> 
        </td>
      </tr>
	  ...
	  <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <input name="l4" id="l4" size="30" type="text"> 
        </td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2" width="40%"><b>Bank Penerbit Kartu<span class="gaia cca red">*<em><font color="#999999" size="-2">/Card 
          Issuer Bank</font></em></span></b></td>
        <td align="left" class="tbl_row2" width="60%"> <input name="bankName_1" id="bankName_1" size="30" type="text"> 
        </td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2"><b>Nama pada Kartu<span class="gaia cca red">*<em><font color="#999999" size="-2">/Name 
          on Card</font></em></span></b></td>
        <td align="left" class="tbl_row2"><input name="nameOnCard" id="nameOnCard" size="30" type="text"></td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2"><b>Telepon Rumah<span class="gaia cca red">*<em><font color="#999999" size="-2">/Home 
          Phone Number</font></em></span></b></td>
        <td align="left" class="tbl_row2"> <input name="homephone" id="homephone" size="30" type="text"> 
        </td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2"><b>Telepon Kantor<span class="gaia cca red">*<em><font color="#999999" size="-2">/Office 
          Phone Number</font></em></span></b></td>
        <td align="left" class="tbl_row2"> <input name="workphone" id="workphone" size="30" type="text"> 
        </td>
      </tr>
      <tr> 
        <td colspan="2" align="left" class="tbl_row2"><table width="99%" border="0" cellpadding="5" cellspacing="0">
            <tr> 
              <td align="left" colspan="2" style="font-weight: bold;"><font colspan="2" id="title_order"> 
                Alamat Rumah<span class="gaia cca blue"><font colspan="2" id="title_order"><b><span class="gaia cca red"><em><font color="#666666" size="-1">/ 
                Home Address</font></em></span></b></font></span></font></td>
            ...
            <tr> 
              <td width="17%" height="39" align="left" class="tbl_row2"><p><b>Alamat<span class="gaia cca red">* 
                  <em><font color="#999999" size="-2">/</font></em></span></b><span class="gaia cca red"><em><font color="#999999" size="-2">Address</font></em></span></p></td>
              <td align="left" class="tbl_row2" width="30%"> <input name="billingAddress_1" id="billingAddress_1" size="30" type="text"> 
              </td>
              <td align="left" class="tbl_row2" width="17%"><p><b>Alamat Penagihan<span class="gaia cca red">* 
                  ...
                  /Billing Address</font></em></span></p></td>
              <td align="left" class="tbl_row2" width="36%"> <input name="billingAddress_2" id="billingAddress_2" size="30" type="text"> 
              </td>
            </tr>
            <tr> 
              <td align="left" class="tbl_row2" width="17%"><span class="gaia cca red"><em><font color="#999999" size="-2">(Line2)</font></em></span></td>
              <td align="left" class="tbl_row2" width="30%"> <input name="AddressLine2_1" id="AddressLine2_1" size="30" type="text"> 
              </td>
              <td align="left" class="tbl_row2" width="17%"><span class="gaia cca red"><em><font color="#999999" size="-2">(Line2)</font></em></span></td>
              <td align="left" class="tbl_row2" width="36%"> <input name="AddressLine2_2" id="AddressLine2_2" size="30" type="text"> 
              </td>
            </tr>
            <tr> 
              <td align="left" class="tbl_row2" width="17%"><b>Kota</b><span class="gaia cca red">* 
                <em><font color="#999999" size="-2"> /City</font></em></span></td>
              <td align="left" class="tbl_row2" width="30%"> <input name="city_1" id="city_1" size="30" type="text"> 
              </td>
              <td align="left" class="tbl_row2" width="17%"><b>Kota</b><span class="gaia cca red">* 
                <em><font color="#999999" size="-2"> /City</font></em></span></td>
              <td align="left" class="tbl_row2" width="36%"> <input name="city_2" id="city_2" size="30" type="text"> 
              </td>
            </tr>
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="state_1" id="state_1" size="30" type="text"> 
              </td>
              <td align="left" class="tbl_row2" width="17%"><b>Wilayah</b><span class="gaia cca red">* 
                <em><font color="#999999" size="-2"> /State</font></em></span></td>
              <td align="left" class="tbl_row2" width="36%"> <input name="state_2" id="state_2" size="30" type="text"> 
              </td>
            </tr>
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="zipCode_1" id="zipCode_1" size="30" type="text"> 
              </td>
              ...
              <td align="left" class="tbl_row2" width="36%"> <input name="zipCode_2" id="zipCode_2" size="30" type="text"> 
              </td>
            </tr>
          </table></td>
      </tr>
      <tr> 
        <td colspan="2" align="right"> <input id="registerbutton" name="registerbutton" class="bttn_change" value="Submit" type="SUBMIT"> 
...
<%
	...
	String destinationLimitAlert = "Anda hanya diperbolehkan untuk memiliki <br>"+destinationLimit+" nomor tujuan";
