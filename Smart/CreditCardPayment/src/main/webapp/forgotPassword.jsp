...
if(resultCode.equals("1")){
	...
	displayMsg="Permintaan Anda tidak bisa diproses, silakan coba lagi";
}
%>
...
<form name="forgotPasswordForm" id="forgotPasswordForm" action="ValidateForgotPassword" method="POST">
   <table align="center" width="460" border="0" cellpadding="5" cellspacing="0" style="background:#fff url(images/m06.png) bottom no-repeat;">
					<tr>
						...
						<h2>Reset Login PIN</h2>
         <br/></td></tr>
              <tr>
						
      <td id="title_order" colspan="2" align="left">Lupa Login PIN Anda? <font color="#999999" size="-1"><em>(Forgot 
        Your Login PIN?)</em></font> </td>
					</tr>
