...
<input type="hidden" name="requestType" value="editProfile" />
    ...
    <table align="center" width="680px" border="0" cellpadding="5" cellspacing="0" style="background:#fff url(images/m09.png) bottom no-repeat;">
      <tr> 
        <td align="left" colspan="2"> <span id="title_order" > </span> <span class="gaia cca blue">Kolom 
      ...
      <tr style="visibility:<%=visibility%>"> 
        <td nowrap="nowrap" valign="top"><font
													face="Arial, sans-serif" size="-1"><b> 
          ErrorMsg : </b></font>&nbsp;</td>
        <td> <div> 
            <label> 
            <%=errorMsg%>
      ...
      <tr> 
        <td colspan="2" align="left" class="tbl_row2"><span id="title_order">Informasi 
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="firstname" id="firstname" size="30" class="update" 
													type="text"
													value="<%=hasError ? "" : ccRegInfo.getFirstName()%>" autocomplete="off">
          </div></td>
      </tr>
      <tr> 
        <td align="left" class="tbl_row2" width="40%"><b>Nama Belakang<span class="gaia cca red"><em><font color="#999999" size="-2">/Last 
          Name </font></em></span></b></td>
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="lastname" id="lastname" size="30" class="update" 
													type="text"
													value="<%=hasError ? "" : ccRegInfo.getLastName()%>">
          </div></td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="securityAnswer" id="securityAnswer" class="update" 
													size="50" autocomplete="off" type="text"
													value="<%=hasError ? "" : ccRegInfo.getSecurityAnswer()%>">
          </div></td>
      </tr>
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div><font face="Arial, sans-serif" size="-1"> 
            <i> 
            <%--tf6_1 value is not going to backend b'coz it is hidden field so using one more field f6_1--%>
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div><font face="Arial, sans-serif" size="-1"> 
            <i> 
            <%--tl3_1 value is not going to backend b'coz it is hidden field so using one more field l3_1
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div><font face="Arial, sans-serif" size="-1"> 
            <i> 
            <input name="bankName_1" id="bankName_1" size="30" class="update" 
													type="text"
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2"> <div> 
            <input name="nameOnCard_1" id="nameOnCard_1" class="update" 
													size="30" type="text"
													value="<%=hasCard ? ccRegInfo.getCcList().get(0).getNameOnCard() : ""%>">
          </div></td>
      </tr>
      <tr> 
        ...
        <td align="left" class="tbl_row2"> <div><font face="Arial, sans-serif" size="-1"><i> 
            <input name="homephone" id="homephone" size="30" class="update" 
													type="text"
      ...
      <tr> 
        <td align="left" class="tbl_row2"><b>Telepon Kantor<span class="gaia cca red">*<em><font color="#999999" size="-2">/Office 
          Phone Number</font></em></span></b></td>
        <td align="left" class="tbl_row2"> <div><font face="Arial, sans-serif" size="-1"> 
            <i> 
            <input name="workphone" id="workphone" size="30" class="update" 
													type="text"
													value="<%=hasError ? "" : ccRegInfo.getWorkPhone()%>">
            </i> </font></div></td>
      </tr>
      <tr> 
        <td colspan="2" align="left" id="title_order">&nbsp;</td>
      </tr>
      <tr> 
        <td colspan="2" align="left" id="title_order"><span class="gaia cca blue"><font colspan="2" id="title_order">Anda 
          diperbolehkan untuk mendaftarkan 2 nomor Smartfren lainnya untuk menerima 
          pembayaran kartu kredit</font></span> <br> <span class="gaia cca blue"><font colspan="2"><b><span class="gaia cca red"><em><font color="#666666" size="-1">/You 
          can enroll 2 more Smartfren number to accept credit card payment</font></em></span></b></font></span></td>
      </tr>
      <tr> 
        ...
        <td align="left" class="tbl_row2"> <div> 
            <input name="destination0" id="destination0"
													size="30" type="text" disabled="disabled"
													value="<%=hasCard ? ccRegInfo.getMdn() : ""%>">
          </div></td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td align="left" class="tbl_row2" width="60%"> <div> 
            <input name="destination<%=i+1%>"
													id="destination<%=i+1%>" size="30" type="text" class='dest'
													value="<%=hasCard ? ccRegInfo.getCcDestinations().get(i).getDestMDN() : ""%>">
          </div>
          <div> 
            <input name="destination<%=i+1%>ID"
													id="destination<%=i+1%>ID" size="30" type="hidden"
													value="<%=hasCard ? ccRegInfo.getCcDestinations().get(i).getID() : ""%>">
          </div>
          <div> 
            <input name="destination<%=i+1%>Version"
													id="destination<%=i+1%>Version" size="30" type="hidden"
													value="<%=hasCard ? ccRegInfo.getCcDestinations().get(i).getVersion() : ""%>">
          </div></td>
      </tr>
      <%
												}
      ...
      <tr> 
        <td colspan="2" id="title_order" align="left"> <table width="99%" border="0" cellpadding="5" cellspacing="0">
            <tr> 
            ...
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="billingAddress_1" id="billingAddress_1" size="30" class="update" 
              ...
              <td align="left" class="tbl_row2" width="31%"> <input name="billingAddress_2" id="billingAddress_2" size="30" type="text" class="update" 
            ...
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="AddressLine2_1" id="AddressLine2_1" size="30" class="update" 
              ...
              <td align="left" class="tbl_row2" width="31%"> <input name="AddressLine2_2" id="AddressLine2_2" size="30" class="update" 
            ...
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="city_1" id="city_1" size="30" class="update" 
              ...
              <td align="left" class="tbl_row2" width="31%"> <input name="city_2" id="city_2" size="30" type="text" class="update" 
            ...
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="state_1" id="state_1" size="30" class="update" 
              ...
              <td align="left" class="tbl_row2" width="31%"> <input name="state_2" id="state_2" size="30" type="text" class="update" 
            ...
            <tr> 
              ...
              <td align="left" class="tbl_row2" width="30%"> <input name="zipCode_1" id="zipCode_1" size="30" type="text" class="update" 
              ...
              <td align="left" class="tbl_row2" width="19%"><b>Kode Pos<span class="gaia cca red">*<em><font color="#999999" size="-2">/Postal 
                Code</font></em></span></b></td>
              <td align="left" class="tbl_row2" width="31%"> <input name="zipCode_2" id="zipCode_2" size="30" type="text" class="update" 
															value="<%=hasCard ? ccRegInfo.getCcList().get(0).getBillingzipCode(): ""%>"> 
              </td>
            </tr>
          </table></td>
      <tr> 
        <td colspan="4" align="right"> <input id="submitbutton" name="submitbutton" class="bttn_submit" type="SUBMIT" value="Update" <%=disabled %>> 
        </td>
      </tr>
      <%--hidden parameters --%>
      <tr> 
        <td> <input type="hidden" name="newdestinations"	id="newdestinations" value="0"> 
          ...
          <%}}	
					String destinationLimitAlert = "Anda hanya diperbolehkan untuk memiliki <b><span class='gaia cca red'>"+destinationLimit+"</b></span> nomor tujuan";
