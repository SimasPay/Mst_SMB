						...
						<td class="tbl_login" align="center">
                                                    <%
                                                    	...
                                                    	if ("0".equals(resultCode)) {
                                                    		displayMsg = "Cek email Anda untuk mengkonfirmasikan perubahan profil Anda." ;
                                                    	} 
                                                    	else if("2".equals(resultCode)){
                                                    		displayMsg = "Perubahan email Anda telah berhasil";
                                                    	}else {
                                                    		displayMsg = "Perubahan email gagal:<br>" + resultMsg +
