...
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="./images/favicon.ico">
  ...
  <h2>Konfirmasi Reset Login PIN<font color="#666666"></font></h2>
      
      
  <em><font color="#666666"><font size="-1">Reset Login PIN Confirmation</font></em></font> 
  <br/>
   <br/>
            <%
                String mdn = "";
                ...
                if("1".equals(restultCode)){
                	resultMsg = "Invalid Smarfren number or code";                	
                }
