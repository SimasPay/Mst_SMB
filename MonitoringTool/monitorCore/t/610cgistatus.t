...
$output = `NAGIOS_CGI_CONFIG=etc/cgi.cfg REMOTE_USER=monitoradmin REQUEST_METHOD=GET QUERY_STRING=host=all $cgi`;
...
$output = `NAGIOS_CGI_CONFIG=etc/cgi.cfg REMOTE_USER=monitoradmin REQUEST_METHOD=GET QUERY_STRING=host=host1 $cgi`;
...
$output = `NAGIOS_CGI_CONFIG=etc/cgi.cfg REMOTE_USER=monitoradmin REQUEST_METHOD=GET QUERY_STRING=host= $cgi`;
...
$output = `NAGIOS_CGI_CONFIG=etc/cgi.cfg REMOTE_USER=monitoradmin REQUEST_METHOD=GET $cgi`;
