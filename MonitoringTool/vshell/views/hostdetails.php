...
function get_host_details($dets)
{
	...
	$page.="	
		...
		<tr><td colspan='2'><a class='label' href='{$dets['CoreLink']}' title='".gettext('See This Host In mFino Monitor Core')."'>".gettext('See This Host In mFino Monitor Core')."</a></td></tr>	
		</table>
		</fieldset>
