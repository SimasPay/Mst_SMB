package com.mfino.billpay.startimes.impl;
...
public class StarTimesEventProcessingServiceImpl extends BillPayEventProcessingServiceImpl {
	...
	public MCEMessage processEvent(@Body MCEMessage mceMessage, @Header("eventContext") String eventContext) {
		log.info("StarTimesBillPayEventProcessingServiceImpl : processEvent BEGIN eventContext=" + eventContext + "mceMessage=" + mceMessage);
	...
	public MCEMessage constructResponse(MCEMessage mceMessage) {
		log.info("StarTimesBillPayEventProcessingServiceImpl :: constructResponse mceMessage$$$=" + mceMessage);
