...
public class ClickatellBillPayMoneyTransferServiceImpl extends BillPayMoneyTransferServiceImpl {
	
	public String getReversalResponseQueue(){
		return "jms:ClickatellSuspenseAndChargesRRQueue?disableReplyTo=true";
	}
	public String getSourceToSuspenseBankResponseQueue(){
		return "jms:ClickatellSourceToSuspenseBRQueue?disableReplyTo=true";
	}
	public String getSuspenseToDestBankResposeQueue(){
		return "jms:ClickatellSuspenseToDestBRQueue?disableReplyTo=true";
	}
